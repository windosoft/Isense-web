...
class CreateHumidityTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('humidity', function (Blueprint $table) {
            ...
            $table->string('name');
            $table->string('warning_low_humidity_threshold');
            $table->string('warning_high_humidity_threshold');
            $table->string('low_humidity_threshold');
            $table->string('high_humidity_threshold');
