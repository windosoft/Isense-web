<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel15"><i class="fa fa-trash"></i> Delete Gateway</h4>
        </div>
        {{ Form::model(null, ['route' => ['admin.gateway.destroy',$uuid], 'files' => true, 'role' => 'form', 'id'=>'frmGateway', 'method'=>'delete']) }}
