...
(function () {
    ...
    function Q(k) {
        var l = ((k & 16711680) >> 16).toString(16), v = ((k & 65280) >> 8).toString(16);
        ...
        if (isNaN(t)) {
            try {
                k = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" +
                    k + "; font-size:" + l + "px; font-weight:" + v + ";";
                if (!wa) {
    ...
    function P(k, l, v, s, t) {
        ...
        t = t || !1;
        s.push([k, l, v, t]);
        return k.addEventListener ? (k.addEventListener(l, v, t), v) : k.attachEvent ? (s = function (l) {
            l = l || window.event;
    ...
    function hb(k) {
        if (!ib) {
            ...
            "undefined" === typeof qa.Chart.creditHref ? (k.creditHref = Y("iuuqr;..b`ow`rkr/bnl."),
                k.creditText = Y("B`ow`rKR/bnl")) : (l = k.updateOption("creditText"), v = k.updateOption("creditHref"));
    ...
    function va(k, l, v) {
        ...
        v && (l.setAttribute("state", v), l.setAttribute("type", "button"), pa(k, l, {
            padding: "5px 12px",
            cursor: "pointer",
            "float": "left",
            width: "40px",
    ...
    var Ha = !1, J = {}, t = !!document.createElement("canvas").getContext, qa = {
        Chart: {
            width: 500,
            height: 400,
            zoomEnabled: !1,
    ...
    }, Ka = {en: {}}, w = t ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Fa = t ? "Impact, Charcoal, sans-serif" :
        "Arial", za = {
    ...
    var U = 20, F = 14, bb = {
        light1: Va, light2: ab, dark1: Fa, dark2: {
            ...
            title: {fontFamily: w, fontSize: 32, fontColor: aa, fontWeight: "normal", verticalAlign: "top", margin: 5},
            subtitles: [{
                fontFamily: w,
                fontSize: F,
                fontColor: aa,
    ...
    var Ya = {}, wa = null, kb =
            ...
            return function (F, N, M) {
                var I = M ? M.days : l, Q = M ? M.months : s, P = M ? M.shortDays : v, R = M ? M.shortMonths : t;
                M = "";
                var J = !1;
                ...
                M = J ? "getUTC" : "get";
                var V = F[M + "Date"](), L = F[M + "Day"](), W = F[M + "Month"](), a = F[M + "FullYear"](),
                    d = F[M + "Hours"](), c = F[M + "Minutes"](), b = F[M + "Seconds"](), e = F[M + "Milliseconds"](),
            ...
            var s = 0 > k ? !0 : !1;
            s && (k *= -1);
            var t = v ? v.decimalSeparator : ".", w = v ? v.digitGroupSeparator :
                ",", E = "";
            l = String(l);
            var E = 1, F = v = "", N = -1, M = [], I = [], Q = 0, J = 0, P = 0, R = !1, V = 0,
                F = l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            l = null;
            ...
            R && (l = Math.floor(k),
                F = -Math.floor(Math.log(k) / Math.LN10 + 1), V = 0 === k ? 0 : 0 === l ? -(Q + F) : String(l).length - Q, E /= Math.pow(10, V));
            0 > N && (N = L);
            E = (k * E).toFixed(J);
            l = E.split(".");
            E = (l[0] + "").split("");
            k = (l[1] + "").split("");
            E && "0" === E[0] && E.shift();
            for (R = F = L = J = N = 0; 0 < M.length;) if (l = M.pop(), "#" === l || "0" === l) if (N++, N === Q) {
                var W = E, E = [];
                if ("0" === l) for (l = Q - J - (W ? W.length : 0); 0 < l;) W.unshift("0"), l--;
                for (; 0 < W.length;) v = W.pop() + v, R++, 0 === R % F && (L === P && 0 < W.length) && (v = w + v)
            } else 0 < E.length ? (v = E.pop() + v, J++, R++) : "0" === l && (v = "0" + v, J++, R++), 0 === R %
            F && (L === P && 0 < E.length) && (v = w + v); else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (L++, F = R, R = 0, 0 < E.length && (v = w + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > V ? l.replace("+", "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function (a) {
                return X(V, a.length)
            }));
            w = "";
            for (M = !1; 0 < I.length;) l = I.shift(), "#" === l || "0" === l ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(), M = !0) : "0" === l && (w += "0", M =
                !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? w += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? w += l : (l = 0 > V ? l.replace("+", "").replace("-", "") : l.replace("-", ""), w += l.replace(/[0]+/, function (a) {
                return X(V, a.length)
            }));
            v += (M ? t : "") + w;
            return s ? "-" + v : v
            ...
            var l = 0, v = 0;
            k = k || window.event;
            k.offsetX || 0 === k.offsetX ? (l = k.offsetX, v = k.offsetY) : k.layerX || 0 == k.layerX ? (l = k.layerX, v = k.layerY) : (l = k.pageX - k.target.offsetLeft,
                v = k.pageY - k.target.offsetTop);
            return {x: l, y: v}
        }, $a = !0, Ra = window.devicePixelRatio || 1, Na = 1, ha = $a ? Ra / Na : 1,
    ...
    V.prototype.createUserOptions = function (k) {
        ...
        this.parent.createUserOptions(), this.isOptionsInArray) {
            ...
            l[s] = this.options
        } else this.options = "undefined" === typeof k ? {} : k, k = this.parent.options, this.optionsName ? l = this.optionsName : (l = this._defaultsKey) && 0 !== l.length ? (s = l.charAt(0).toLowerCase(), 1 < l.length && (s = s.concat(l.slice(1))),
    ...
    V.prototype.updateOption = function (k) {
        ...
        var l = qa[this._defaultsKey], t = {}, w = this[k], F = this._themeOptionsKey,
            J = this._index;
    ...
    V.prototype.dispatchEvent = function (k, l, s) {
        if (k && this._eventListeners[k]) {
            l = l || {};
            for (var t = this._eventListeners[k], w = 0; w < t.length; w++) t[w].eventHandler.call(t[w].context,
                l)
        }
    ...
    ja.prototype.render = function (k) {
        if (0 !== this.fontSize) {
            ...
            var t = 0, w = this.topPadding, F = null;
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++) F =
                this._wrappedText.lines[s], "right" === this.horizontalAlign ? t = this.width - F.width - this.rightPadding : "left" === this.horizontalAlign ? t = this.leftPadding : "center" === this.horizontalAlign && (t = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding), this.ctx.fillText(F.text, t, w), w += F.height;
            this.ctx.font = l;
            k && this.ctx.restore()
        }
    };
    ...
    ja.prototype._getLineWithWidth = function (k, l, s) {
        ...
        var t = s = 0, w = k.length - 1, F = Infinity;
        for (this.ctx.font = this._getFontString(); t <= w;) {
            var F = Math.floor((t + w) / 2), E = k.substr(0, F + 1);
            s = this.ctx.measureText(E).width;
            if (s < l) t = F + 1; else if (s > l) w = F - 1; else break
        }
        s > l && 1 < E.length && (E =
            E.substr(0, E.length - 1), s = this.ctx.measureText(E).width);
        l = !0;
    ...
    ja.prototype._wrapText = function () {
        var k = new String(Ga(String(this.text))), l = [], s = this.ctx.font, t = 0, w = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) w = t = 0; else for (; 0 < k.length;) {
            var F = this.maxHeight - (this.topPadding + this.bottomPadding),
                E = this._getLineWithWidth(k, this.maxWidth -
                    (this.leftPadding + this.rightPadding), !1);
            E.height = this._lineHeight;
            l.push(E);
            var J = w, w = Math.max(w, E.width), t = t + E.height, k = Ga(k.slice(E.text.length, k.length));
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, l = k.layoutManager.getFreeSpace(),
                t = l.x1, w = l.y1, F = 0, J = 0,
                E = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, I;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth =
            ...
            var M;
            s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !== typeof this.padding || (M = this.padding.top ? this.padding.top : this.padding.bottom ?
                this.padding.bottom : 0, M += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : M = 2 * this.padding;
    ...
    Ua.prototype.get = function (k, l) {
        var s = null;
        0 < this.pool.length ? (s = this.pool.pop(), Ma(s, k,
            l)) : s = ta(k, l);
        return s
    };
    ...
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports =
        Pa : "function" === typeof define && define.amd ? define([], function () {
        return Pa
    ...
    w = Pa.Chart = function () {
        ...
        function l(a, d, c) {
            d = d || {};
            s(c) ? (this.predefinedThemes = bb, this.optionsName = this.parent = this.index = null) : (this.parent =
                c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ?
                ...
                this._eventManager = new ca(this), this.windowResizeHandler = P(window, "resize", function () {
                ...
                b._touchEventHandler(a)
            }, this.allDOMEventHandlers), this.toolTip = new X(this, this.options.toolTip),
                this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {
                axisX: [],
                axisX2: [],
                axisY: [],
                axisY2: []
        ...
        function w(a, d, c, b, e, f, n, m, A, h) {
            ...
            r = 0 < n.trimLength ?
                Math.abs(r * n.trimLength / 100) : Math.abs(r - n.length);
            A ? (c += r / 2, e -= r / 2) : (d += r / 2, b -= r / 2);
            var r = 1 === Math.round(n.thickness) % 2 ? 0.5 : 0, q = 1 === Math.round(m.thickness) % 2 ? 0.5 : 0;
            a.save();
            a.globalAlpha = h;
            ...
            a.beginPath();
            A && 0 < m.thickness ? (a.moveTo(b - n.thickness / 2, Math.round((c + e) / 2) - q), a.lineTo(d + n.thickness / 2, Math.round((c + e) / 2) - q)) : 0 < m.thickness && (a.moveTo(Math.round((d + b) / 2) - q, c + n.thickness / 2), a.lineTo(Math.round((d +
                b) / 2) - q, e - n.thickness / 2));
            a.stroke();
        ...
        function E(a, d, c, b, e, f) {
            ...
            f ? (this.optionsName = "axisX", s(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisX[b]) : (this.optionsName = "axisX2", s(this.chart.sessionVariables.axisX2[b]) && (this.chart.sessionVariables.axisX2[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisX2[b]), this.options.interval || (this.intervalType = null)) : "left" === f || "bottom" === f ? (this.optionsName = "axisY", s(this.chart.sessionVariables.axisY[b]) && (this.chart.sessionVariables.axisY[b] =
                {}), this.sessionVariables = this.chart.sessionVariables.axisY[b]) : (this.optionsName = "axisY2", s(this.chart.sessionVariables.axisY2[b]) && (this.chart.sessionVariables.axisY2[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisY2[b]);
            "undefined" === typeof this.options.titleFontSize && (this.titleFontSize = this.chart.getAutoFontSize(this.titleFontSize));
            "undefined" === typeof this.options.labelFontSize && (this.labelFontSize = this.chart.getAutoFontSize(this.labelFontSize));
            this.type = e;
            "axisX" !== e || c && "undefined" !==
            typeof c.gridThickness || (this.gridThickness = 0);
            this._position = f;
            ...
            this.stripLines = [];
            if (this.options.stripLines && 0 < this.options.stripLines.length) for (a =
                                                                                        0; a < this.options.stripLines.length; a++) this.stripLines.push(new M(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this));
        ...
        function U(a, d, c, b, e, f) {
            ...
            this.lineThickness =
                s(c.lineThickness) ? f.lineThickness : this.lineThickness;
        ...
        l.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this._resetButton || (d = !1, ua(this._resetButton = document.createElement("button")), va(this, this._resetButton,
                    "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor, this._toolBar.appendChild(this._resetButton), P(this._resetButton, "touchstart", function (a) {
                    d = !0
                    ...
                    a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, va(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor =
                        a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
                    ...
                    if (a.sessionVariables.axisY) for (b = 0; b < a.sessionVariables.axisY.length; b++) a.sessionVariables.axisY[b].newViewportMinimum =
                    ...
                    a.stockChart &&
                    (a.stockChart._rangeEventParameter.type = "rangeChanging", a.stockChart.dispatchEvent("rangeChanging", a.stockChart._rangeEventParameter, a.stockChart));
                    a.render();
            ...
            gb(this);
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? va(a,
                a._zoomButton, "zoom") : va(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && va(a, a._resetButton, "reset"));
        ...
        l.prototype._updateSize = function () {
            ...
            var d = 0, c = 0;
            this.options.width ? d = this.width :
                this.width = d = 0 < this.container.clientWidth ? this.container.clientWidth : this.width;
        ...
        l.prototype._initialize = function () {
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++) if (a++, !this.options.data[c].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[c].type)) {
                    var b = new I(this,
                        this.options.data[c], a - 1, ++this._eventManager.lastObjectId);
                    ...
                    null === b.color ? 1 < this.options.data.length ? (b._colorSet =
                    ...
                    "normal" === e ? "xySwapped" === this.plotInfo.axisPlacement ? f = 'You cannot combine "' +
        ...
        l.prototype.setLayout = function () {
            ...
            c ? (La(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness +
        ...
        l.prototype.renderElements = function () {
            ...
            if ("normal" ===
                this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) E.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return;
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++) for (var f = this.plotInfo.plotTypes[d], n = 0; n < f.plotUnits.length; n++) {
                ...
                "line" === m.type ? A = this.renderLine(m) : "stepLine" === m.type ? A = this.renderStepLine(m) : "spline" === m.type ? A = this.renderSpline(m) : "column" === m.type ? A = this.renderColumn(m) : "bar" === m.type ? A = this.renderBar(m) : "area" === m.type ? A = this.renderArea(m) : "stepArea" === m.type ? A = this.renderStepArea(m) : "splineArea" === m.type ? A = this.renderSplineArea(m) :
        ...
        l.prototype.categoriseDataSeries = function () {
            for (var a = "", d = 0; d < this.data.length; d++) if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
                ...
                for (n = 0; n <
                c.plotUnits.length; n++) if (c.plotUnits[n].axisYType === a.axisYType && c.plotUnits[n].axisXType === a.axisXType && c.plotUnits[n].axisYIndex === a.axisYIndex && c.plotUnits[n].axisXIndex === a.axisXIndex) {
                    f = !0;
                    e = c.plotUnits[n];
                    break
                }
        ...
        l.prototype._processMultiseriesPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]], A = 0, h = !1, r = !1, q;
        ...
        l.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = [], m = [], A = Infinity, h = -Infinity, r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var q =
                        this.data[a.dataSeriesIndexes[r]], p = 0, g = !1, C = !1, k;
                    ...
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, n),
                        d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, m)) : (d.dataPointYPositiveSums = n, d.dataPointYNegativeSums = m));
                ...
                for (p in m) m.hasOwnProperty(p) && !isNaN(p) && (a = m[p], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), p < c.viewPortMin ||
        ...
        l.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = !1, m = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var r = this.data[a.dataSeriesIndexes[h]], q = 0, p = !1, g = !1, C;
                    if ("normal" === r.axisPlacement || "xySwapped" === r.axisPlacement) var k = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum :
                    ...
                    if (r.dataPoints[q].x && r.dataPoints[q].x.getTime || "dateTime" === r.xValueType) f =
                        !0;
                    for (q = 0; q < r.dataPoints.length; q++) {
                        ...
                        if (b < k && !p) null !== e && (C = b); else {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && C < b && (c.viewPortMin = C) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] :
                ...
                a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : n && !m ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : n && m ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ?
                    -99 : Math.min(d.viewPortMin, -99)) : !n && m && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = A
            }
        ...
        l.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, n, m = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                var h = this.data[a.dataSeriesIndexes[A]], r = 0, q = !1, p = !1, g, C, k;
                if ("normal" === h.axisPlacement ||
                    ...
                    u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX &&
                    this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
        ...
        l.prototype._processSpecificPlotUnit =
            function (a) {
                if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var m = this.data[a.dataSeriesIndexes[n]], A = 0, h = !1, r = !1, q = b = 0;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var p = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX &&
                    ...
                    if (m.dataPoints[A].x && m.dataPoints[A].x.getTime || "dateTime" === m.xValueType) f = !0;
                    for (A = 0; A < m.dataPoints.length; A++) "undefined" !== typeof m.dataPoints[A].isCumulativeSum &&
                    !0 === m.dataPoints[A].isCumulativeSum ? (m.dataPointEOs[A].cumulativeSumYStartValue = 0, m.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum, m.dataPoints[A].y = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum) : "undefined" !== typeof m.dataPoints[A].isIntermediateSum && !0 === m.dataPoints[A].isIntermediateSum ? (m.dataPointEOs[A].cumulativeSumYStartValue = q, m.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum, m.dataPoints[A].y = 0 === A ? 0 : b, q = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum,
                        b = 0) : (e = "number" !== typeof m.dataPoints[A].y ? 0 : m.dataPoints[A].y, m.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum, m.dataPointEOs[A].cumulativeSum = 0 === A ? e : m.dataPointEOs[A - 1].cumulativeSum + e, b += e);
                    for (A = 0; A < m.dataPoints.length; A++) if ("undefined" === typeof m.dataPoints[A].x && (m.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), m.dataPoints[A].x.getTime ? (f = !0, b = m.dataPoints[A].x.getTime()) : b = m.dataPoints[A].x, e = m.dataPoints[A].y, b < c.min && (c.min = b), b > c.max && (c.max = b), m.dataPointEOs[A].cumulativeSum <
        ...
        l.prototype.calculateAutoBreaks = function () {
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, n = f.max, m = d.min, r = d.max, f = f._dataRanges, d = d._dataRanges, p, q = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                        ...
                        if (!(4 > k.dataPoints.length)) for (q = 0; q < k.dataPoints.length; q++) if (b && (p = (n + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[q].x.getTime ? k.dataPoints[q].x.getTime() : k.dataPoints[q].x, p = Math.floor((g - h) / p), g < f[p].min && (f[p].min = g), g > f[p].max && (f[p].max = g)), c) {
                            ...
                            if ((g = "waterfall" === a.type ? k.dataPointEOs[q].cumulativeSum : k.dataPoints[q].y) && g.length) for (var t = 0; t < g.length; t++) p =
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (!(4 > m.dataPoints.length)) for (h =
            ...
            if (f) {
                ...
                for (n = 0; n < this._axes.length; n++) if (this._axes[n].dataInfo._dataRanges) {
                    ...
                    var h = this._axes[n].dataInfo._dataRanges, r, q, f = [];
                    ...
                    for (m = 0; m < h.length -
                    1; m++) if (r = h[m].max, isFinite(r)) for (; m < h.length - 1;) if (A = h[m + 1].min, isFinite(A)) {
                        q = A - r;
                        q > b && f.push({diff: q, start: r, end: A});
                        break
                    } else m++;
                    if (this._axes[n].scaleBreaks.customBreaks) for (m = 0; m < this._axes[n].scaleBreaks.customBreaks.length; m++) for (b = 0; b < f.length; b++) if (this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue ||
                        f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].startValue && this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].end || f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue && this._axes[n].scaleBreaks.customBreaks[m].endValue <= f[b].end) f.splice(b, 1), b--;
                    f.sort(function (a, b) {
                        return b.diff - a.diff
                    });
                    for (m = 0; m < Math.min(f.length, this._axes[n].scaleBreaks.maxNumberOfAutoBreaks); m++) b = a(f[m].start, f[m].end, this._axes[n].logarithmic ? this._axes[n].dataInfo.max / this._axes[n].dataInfo.min :
        ...
        l.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            for (c = 0; c < b.length; c++) if ("line" ===
                b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type) if (e = la("markerSize", b[c].dataPoint, b[c].dataSeries) || 8, b[c].distance <= e / 2) {
                d = !0;
                break
            }
        ...
        l.prototype.getObjectAtXY = function (a, d, c) {
            ...
            if (c = this.getDataPointAtXY(a,
                d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (t) b = Za(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
        ...
        l.prototype._touchEventHandler = function (a) {
            if (a.changedTouches &&
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    e.time = new Date;
                    try {
                        var n = e.y - this._lastTouchData.y, f = e.time - this._lastTouchData.time;
                        if (1 < Math.abs(n) && this._lastTouchData.scroll || 5 < Math.abs(n) && 250 > f) this._lastTouchData.scroll = !0
                    } catch (m) {
                    }
                    this._lastTouchEventType = a.type;
                    if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (c = 0; c < d.length; c++) if (e = d[c], n = document.createEvent("MouseEvent"), n.initMouseEvent(e, !0, !0, window,
        ...
        l.prototype._plotAreaMouseUp = function (a, d) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                var c = d - this.dragStartPoint.y, b = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"),
                    f = 0 <= this.zoomType.indexOf("y"), n = !1;
                this.resetOverlayedCanvas();
                if ("xySwapped" === this.plotInfo.axisPlacement) var m = f, f = e, e = m;
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisY && 0 < this.axisY.length) for (n = 0; n < this.axisY.length; n++) this.axisY[n].crosshair && this.axisY[n].crosshair.enabled &&
        ...
        l.prototype._plotAreaMouseMove = function (a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisX && 0 < this.axisX.length) for (e =
                                                                  0; e < this.axisX.length; e++) this.axisX[e].crosshair && this.axisX[e].crosshair.enabled && this.axisX[e].renderCrosshair(a, d);
        ...
        l.prototype.validateRegion = function (a, d, c, b, e) {
            ...
            for (n = 0; n < h.length; n++) {
                var q = h[n], f = !1, p = q.convertPixelToValue({x: a, y: d}), g = q.convertPixelToValue({x: c, y: b});
                if (p > g) var C = g, g = p, p = C;
                if (q.scaleBreaks) for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++) f =
                    q.scaleBreaks._appliedBreaks[C].startValue <= p && q.scaleBreaks._appliedBreaks[C].endValue >= g;
        ...
        l.prototype.preparePlotArea =
            function () {
                ...
                t || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left =
                    a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1));
                a.layoutManager = new Ea(a.x1, a.y1, a.x2, a.y2, 2)
            };
        l.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea, b = 0, e = 0, f = 0, n = 0, m = b = n = e = f = 0, A = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                var h = this._indexLabels[a], r = h.chartType.toLowerCase(), q, p,
                ...
                var n = la("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                    ...
                    l = s(h.dataPoint.indexLabelLineThickness) ? s(h.dataSeries.options.indexLabelLineThickness) ? 0 : h.dataSeries.options.indexLabelLineThickness :
                    ...
                    u = {percent: null, total: null}, x = null;
                ...
                if (null !== z && "" !== z) {
                    var u = la("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        x = la("indexLabelOrientation", h.dataPoint,
                            h.dataSeries), D = h.direction, y = h.dataSeries.axisX, B = h.dataSeries.axisY, v = !1,
                        g = new ja(d, {
                            x: 0,
                            y: 0,
                    ...
                    if ("stackedarea100" === r) {
                    ...
                    } else if (0 <= r.indexOf("column") || "waterfall" === r ||
                        ...
                        if (h.dataPoint.x < y.viewportMinimum || h.dataPoint.x > y.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > B.viewportMaximum) continue
                    } else if (h.dataPoint.x <
                        y.viewportMinimum || h.dataPoint.x > y.viewportMaximum) continue;
                    e = n = 2;
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        q = h.point.x - m / 2;
                        "inside" !== u ? (e = c.y1, f = c.y2, 0 < D ? (p = h.point.y - A - n - b, p < e && (p = "auto" === u ? Math.max(h.point.y, e) + n + b : e + n + b, v = p + A > h.point.y)) : (p = h.point.y + n + b, p > f - A - n - b && (p =
                        ...
                        c.x1) + m / 2 + e : Math.min(h.bounds.x2, c.x2) - m / 2 - e : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2, q = 0 > D ? Math.max(h.point.x, b) - m / 2 : Math.min(h.point.x, b) - m / 2, q = Math.max(q, n));
                    "vertical" === x && (p += A);
                    g.x = q;
                    g.y = p;
                    g.render(!0);
                    l && ("inside" !== u && (0 > r.indexOf("bar") && ("error" !== r || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 || !v) && (0 > r.indexOf("column") && ("error" !== r || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2 || !v)) && (d.lineWidth = l, d.strokeStyle = k ? k : "gray", d.setLineDash && d.setLineDash(N(C, l)),
            ...
            for (a = 0; a <
            this._indexLabels.length; a++) h = this._indexLabels[a], g = la("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), h.dataSeries.indexLabelBackgroundColor = s(g) ? t ? "transparent" : null : g;
            return d
        };
        l.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var A =
                        a.dataSeriesIndexes[m], h = this.data[A];
                    c.lineWidth = h.lineThickness;
                    var r = h.dataPoints, q = "solid";
                    if (c.setLineDash) {
                        var p = N(h.nullDataLineDashType, h.lineThickness), q = h.lineDashType,
                            g = N(q, h.lineThickness);
                        c.setLineDash(g)
                    }
                    var C = h.id;
                    this._eventManager.objectMap[C] = {objectType: "dataSeries", dataSeriesIndex: A};
                    C = Q(C);
                    b.strokeStyle = C;
                    b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0;
                    var C = h._colorSet, k = C = h.lineColor = h.options.lineColor ? h.options.lineColor : C[0];
                    c.strokeStyle = C;
                    var l = !0, u = 0, x, s;
                    c.beginPath();
                    if (0 < r.length) {
                        for (var D = !1, u = 0; u < r.length; u++) if (x = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !D))) if ("number" !== typeof r[u].y) 0 < u && !(h.connectNullData || D || l) && (c.stroke(), t && b.stroke()), D = !0; else {
                            ...
                            n = {x: x, y: s};
                            u < r.length - 1 && (k !== (r[u].lineColor || C) || q !== (r[u].lineDashType ||
                                h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), k = r[u].lineColor || C, c.strokeStyle = k, c.setLineDash && (r[u].lineDashType ? (q = r[u].lineDashType, c.setLineDash(N(q, h.lineThickness))) : (q = h.lineDashType, c.setLineDash(g))));
                            ...
                            (r[u].indexLabel || h.indexLabel || r[u].indexLabelFormatter || h.indexLabelFormatter) &&
        ...
        l.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f =
                    ...
                    var A = a.dataSeriesIndexes[m], h = this.data[A];
                    c.lineWidth = h.lineThickness;
                    var r = h.dataPoints, q = "solid";
                    if (c.setLineDash) {
                        var p = N(h.nullDataLineDashType, h.lineThickness), q = h.lineDashType,
                    ...
                    b.strokeStyle = C;
                    b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0;
                    var C = h._colorSet, k = C = h.lineColor = h.options.lineColor ? h.options.lineColor :
                        C[0];
                    c.strokeStyle = C;
                    var l = !0, u = 0, x, s;
                    c.beginPath();
                    if (0 < r.length) {
                        for (var D = !1, u = 0; u < r.length; u++) if (x = r[u].getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !D))) if ("number" !== typeof r[u].y) 0 < u && !(h.connectNullData || D || l) && (c.stroke(), t && b.stroke()), D = !0; else {
                            ...
                            (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                            n = {x: x, y: s};
                ...
                c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), b.beginPath());
                c.restore();
                c.beginPath();
                return {
                    source: d,
        ...
        l.prototype.renderSpline = function (a) {
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    b.setLineDash(a[c + 3].newLineDashArray), t && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
                    b.stroke();
                    t && e.stroke()
                }
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    var l = 0, u, s, z = [];
                    b.beginPath();
                    if (0 < r.length) for (s = !1, l = 0; l < r.length; l++) if (u = r[l].getTime ? r[l].x.getTime() : r[l].x,
                        ...
                        (r[l].indexLabel ||
                            h.indexLabel || r[l].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "spline",
                            dataPoint: r[l],
                            dataSeries: h,
                            point: {x: u, y: s},
                ...
                W.drawMarkers(n);
                t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(f.x1, f.y1, f.width, f.height), e.beginPath());
                b.restore();
                b.beginPath();
                return {
                    source: c,
        ...
        l.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                q = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(q) /
                    Math.log(a.axisX.range) : Math.abs(q) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
                ...
                c.rect(e.x1, e.y1, e.width, e.height);
                c.clip();
                t && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                    e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                for (r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var p = a.dataSeriesIndexes[r], g = this.data[p], C = g.dataPoints;
                    if (0 < C.length) for (var k = 5 < q && g.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++) if (C[f].getTime ? A = C[f].x.getTime() : A = C[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof C[f].y) {
                        ...
                        n = a.axisX.reversed ? n + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount +
                            r) * q << 0 : n - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + r) * q << 0;
                        var l = a.axisX.reversed ? n - q << 0 : n + q << 0, u;
                        0 <= C[f].y ? u = h : (u = m, m = h);
                        m > u && (b = m, m = u, u = b);
                        ...
                        (C[f].indexLabel ||
                            g.indexLabel || C[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "column",
                            dataPoint: C[f],
                            dataSeries: g,
                            point: {x: n + (l - n) / 2, y: 0 > C[f].y === a.axisY.reversed ? m : u},
                            direction: 0 > C[f].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: n, y1: Math.min(m, u), x2: l, y2: Math.max(m, u)},
                            color: b
                        })
                    }
                }
        ...
        l.prototype.renderStackedColumn = function (a) {
            var d =
                a.targetCanvasCtx || this.plotArea.ctx, c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], n = [], m = [], A = [], h = 0, r, q,
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var k = a.dataSeriesIndexes[C], l = this.data[k], u = l.dataPoints;
                    if (0 < u.length) {
                        var s = 5 < g && l.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (h = 0; h < u.length; h++) if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                        "number" === typeof u[h].y) {
                            r = a.axisX.convertValueToPixel(b);
                            var z = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, D = z + g << 0, y;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) m[b] = u[h].y + (m[b] ? m[b] : 0), 0 < m[b] && (q = a.axisY.convertValueToPixel(m[b]), y = "undefined" !== typeof f[b] ? f[b] : p, f[b] = q); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = u[h].y + (A[b] ? A[b] : 0), y = a.axisY.convertValueToPixel(A[b]), q = "undefined" !== typeof n[b] ?
                                n[b] : p, n[b] = y; else if (q = a.axisY.convertValueToPixel(u[h].y), 0 <= u[h].y) {
                            ...
                            b = Q(b);
                            t && ba(this._eventManager.ghostCtx, z, q, D, y, b, 0, null, !1,
                                !1, !1, !1);
                            (u[h].indexLabel || l.indexLabel || u[h].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                bounds: {x1: z, y1: Math.min(q, y), x2: D, y2: Math.max(q, y)},
                                color: b
                            })
                        }
                    }
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < u.length) for (var s = 5 < g && l.bevelEnabled ? !0 : !1, h = 0; h < u.length; h++) if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                        ...
                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) {
                            ...
                            y = f[b] ? f[b] : p;
                            f[b] = q
                        } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = q + ("undefined" !== typeof A[b] ? A[b] : 0),
                            y = a.axisY.convertValueToPixel(A[b]), q = n[b] ? n[b] : p, n[b] = y; else if (q = a.axisY.convertValueToPixel(q), 0 <= u[h].y) {
                            var B = "undefined" !== typeof f[b] ? f[b] : 0;
                            q -= B;
                            y = p - B;
        ...
        l.prototype.renderBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, n, m, A,
                    h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                    r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth :
                        this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0,
                    q = a.axisX.dataInfo.minDiff;
                isFinite(q) || (q = 0.3 * Math.abs(a.axisX.range));
                ...
                (this.dataPointMinWidth && r < f) && (r = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
                q < f && (q = f);
                q > r && (q = r);
                c.save();
                t && this._eventManager.ghostCtx.save();
                ...
                for (r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < C.length) {
                        ...
                        for (f = 0; f < C.length; f++) if (C[f].getTime ? A = C[f].x.getTime() : A = C[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof C[f].y) {
                            ...
                            var l = a.axisX.reversed ? m - q << 0 : m + q << 0, u;
                            0 <= C[f].y ? u = h : (u = n, n = h);
                            b = C[f].color ? C[f].color :
                            ...
                            (C[f].indexLabel || g.indexLabel || C[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > C[f].y === a.axisY.reversed ?
                                    1 : -1,
                                bounds: {x1: Math.min(u, n), y1: m, x2: Math.max(u, n), y2: l},
                                color: b
                            })
                        }
                    }
        ...
        l.prototype.renderStackedBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                this.dataPointMaxWidth && h > q && (h = Math.min(this.options.dataPointWidth ?
                    this.dataPointWidth : Infinity, q));
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (h = 0; h < u.length; h++) if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                            ...
                            var z = q - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, D = z + g << 0, y;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) m[b] = u[h].y + (m[b] ? m[b] : 0), 0 < m[b] && (y = f[b] ? f[b] :
                                p, f[b] = r = a.axisY.convertValueToPixel(m[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = u[h].y + (A[b] ? A[b] : 0), r = n[b] ? n[b] : p, n[b] = y = a.axisY.convertValueToPixel(A[b]); else if (r = a.axisY.convertValueToPixel(u[h].y), 0 <= u[h].y) {
                                var B = f[b] ? f[b] : 0;
                                y = p + B;
                                r += B;
                                f[b] = B + (r - y)
                            ...
                            (u[h].indexLabel || l.indexLabel || u[h].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > u[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(y, r), y1: z, x2: Math.max(y, r), y2: D},
                                color: b
                            })
                        }
                    }
        ...
        l.prototype.renderStackedBar100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                    q < h) && (q = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h));
                g < h && (g = h);
                g > q && (g = q);
                c.save();
                t && this._eventManager.ghostCtx.save();
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (h = 0; h < u.length; h++) if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
                            ...
                            var D = q - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, y = D + g << 0;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[h].y) {
                                m[b] = z + (m[b] ? m[b] : 0);
                                if (0 >= m[b]) continue;
                                z = f[b] ? f[b] : p;
                                ...
                                0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[h].y) A[b] = z + (A[b] ? A[b] : 0), r = n[b] ? n[b] : p, n[b] = z = a.axisY.convertValueToPixel(A[b]); else if (r = a.axisY.convertValueToPixel(z), 0 <= u[h].y) {
                                var B = f[b] ? f[b] : 0;
                                z = p + B;
                                r += B;
                            ...
                            (u[h].indexLabel || l.indexLabel || u[h].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > u[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(z, r), y1: D, x2: Math.max(z, r), y2: y},
                                color: b
                            })
                        }
                    }
        ...
        l.prototype.renderArea = function (a) {
            ...
            var e = a.targetCanvasCtx || this.plotArea.ctx, f = t ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var n = this._eventManager.ghostCtx, m = a.axisY.lineCoordinates, A = [], h = this.plotArea, r;
                f.save();
                t && n.save();
                f.beginPath();
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    var p = a.dataSeriesIndexes[q], g = this.data[p], C =
                        g.dataPoints, A = g.id;
                    this._eventManager.objectMap[A] = {objectType: "dataSeries", dataSeriesIndex: p};
                    A = Q(A);
                    n.fillStyle = A;
                    A = [];
                    d = !0;
                    var k = 0, l, u, s,
                        z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), D, y = null;
                    if (0 < C.length) {
                        var B = g._colorSet[k % g._colorSet.length], v = g.lineColor = g.options.lineColor || B, w = v;
                        f.fillStyle = B;
                        f.strokeStyle = v;
                        ...
                        for (var ka = !0; k < C.length; k++) if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ka))) if ("number" !== typeof C[k].y) g.connectNullData || (ka || d) || b(), ka = !0; else {
                            ...
                            d || ka ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = l, c = u, l = r.x, u = r.y, b(), f.moveTo(r.x,
                                r.y), l = d, u = c, y = r, c = g.nullDataLineDashType, f.setLineDash(T)), f.lineTo(l, u), t && n.lineTo(l, u)) : (f.beginPath(), f.moveTo(l, u), t && (n.beginPath(), n.moveTo(l, u)), y = {
                                x: l,
                                y: u
        ...
        l.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    if (0 < r.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), t &&
                        e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle && (b.strokeStyle = c[d + 3].newStrokeStyle), c[d + 3].newLineDashArray && b.setLineDash(c[d + 3].newLineDashArray);
                        b.stroke()
                    }
                    b.beginPath();
                    b.moveTo(c[0].x, c[0].y);
                    t && (e.beginPath(), e.moveTo(c[0].x, c[0].y));
                    for (d = 0; d < c.length - 3; d += 3) b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), t && e.bezierCurveTo(c[d +
                    1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e =
                    this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, n = [], m = this.plotArea;
                b.save();
                t && e.save();
                b.beginPath();
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var h = a.dataSeriesIndexes[A], r = this.data[h], q = r.dataPoints, n = r.id;
                    this._eventManager.objectMap[n] = {objectType: "dataSeries", dataSeriesIndex: h};
                    n = Q(n);
                    e.fillStyle = n;
                    var n = [], p = 0, g, C,
                        k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                            0), l, u = null, s = [];
                    if (0 < q.length) {
                        var z = r._colorSet[p % r._colorSet.length], D = r.lineColor = r.options.lineColor || z, y = D;
                        b.fillStyle = z;
                        b.strokeStyle = D;
                        b.lineWidth = r.lineThickness;
                        var B = "solid";
                        if (b.setLineDash) {
                            var w = N(r.nullDataLineDashType, r.lineThickness), B = r.lineDashType,
                                E = N(B, r.lineThickness);
                            b.setLineDash(E)
                        }
                        for (C = !1; p < q.length; p++) if (g = q[p].x.getTime ? q[p].x.getTime() : q[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !C))) if ("number" !== typeof q[p].y) 0 < p &&
                        !C && (r.connectNullData ? b.setLineDash && (0 < s.length && (r.options.nullDataLineDashType || !q[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = w, B = r.nullDataLineDashType) : (d(), s = [])), C = !0; else {
                            ...
                            s[s.length] = {x: g, y: C};
                            p < q.length - 1 && (y !== (q[p].lineColor || D) || B !== (q[p].lineDashType || r.lineDashType)) && (y = q[p].lineColor ||
                                D, s[s.length - 1].newStrokeStyle = y, b.setLineDash && (q[p].lineDashType ? (B = q[p].lineDashType, s[s.length - 1].newLineDashArray = N(B, r.lineThickness)) : (B = r.lineDashType, s[s.length - 1].newLineDashArray = E)));
                ...
                t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(m.x1,
                    m.y1, m.width, m.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        l.prototype.renderStepArea = function (a) {
            ...
            function b() {
                y && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? D = z : 0 > a.axisY.viewportMaximum ? D = m.y1 : 0 < a.axisY.viewportMinimum && (D = z), f.lineTo(l, D), f.lineTo(y.x, D), f.closePath(), f.globalAlpha = g.fillOpacity,
                    f.fill(), f.globalAlpha = 1, t && (n.lineTo(l, D), n.lineTo(y.x, D), n.closePath(), n.fill()), f.beginPath(), f.moveTo(l, u), n.beginPath(), n.moveTo(l, u), y = {
                    x: l,
                    y: u
                })
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    var p =
                        a.dataSeriesIndexes[q], g = this.data[p], C = g.dataPoints, A = g.id;
                    this._eventManager.objectMap[A] = {objectType: "dataSeries", dataSeriesIndex: p};
                    A = Q(A);
                    n.fillStyle = A;
                    A = [];
                    ...
                    if (0 < C.length) {
                        ...
                        if (f.setLineDash) {
                            var S = N(g.nullDataLineDashType, g.lineThickness),
                                T = g.lineDashType, E = N(T, g.lineThickness);
                            f.setLineDash(E)
                        }
                        for (; k < C.length; k++) if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                            var Z = u;
                            "number" !== typeof C[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (l = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(C[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || T === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = l,
                                c = u, l = r.x, u = r.y, b(), f.moveTo(r.x, r.y), l = d, u = c, y = r, T = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(l, Z), f.lineTo(l, u), t && (n.lineTo(l, Z), n.lineTo(l, u))) : (f.beginPath(), f.moveTo(l, u), t && (n.beginPath(), n.moveTo(l, u)), y = {
                                x: l,
                                y: u
                            }), c = d = !1) : (f.lineTo(l, Z), t && n.lineTo(l, Z), f.lineTo(l, u), t && n.lineTo(l, u), 0 == k % 250 && b()), r = {
                                x: l,
                                y: u
                            }, k < C.length - 1 && (w !== (C[k].lineColor || v) || T !== (C[k].lineDashType || g.lineDashType)) && (b(), w = C[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (C[k].lineDashType ? (T = C[k].lineDashType,
                                f.setLineDash(N(T, g.lineThickness))) : (T = g.lineDashType, f.setLineDash(E)))), s = g.dataPointIds[k], this._eventManager.objectMap[s] = {
                                id: s,
                                objectType: "dataPoint",
                                dataSeriesIndex: p,
                                dataPointIndex: k,
                            ...
                            })), (C[k].indexLabel || g.indexLabel || C[k].indexLabelFormatter || g.indexLabelFormatter) &&
                            this._indexLabels.push({
                                chartType: "stepArea",
                                dataPoint: C[k],
                                dataSeries: g,
        ...
        l.prototype.renderStackedArea = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = t ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, n = [], m = this.plotArea, A = [], h = [], r = [], q = [], p = 0, g, k,
                    l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    s = this._eventManager.ghostCtx, u, x, z;
                t && s.beginPath();
                b.save();
                t && s.save();
                b.beginPath();
                ...
                for (var e = [], D = 0; D < a.dataSeriesIndexes.length; D++) {
                    var y =
                        a.dataSeriesIndexes[D], B = this.data[y], v = B.dataPoints;
                    B.dataPointIndexes = [];
                ...
                for (D = 0; D < a.dataSeriesIndexes.length; D++) {
                    ...
                    s.fillStyle = p;
                    if (0 < r.length) {
                        var e = B._colorSet[0], w = B.lineColor = B.options.lineColor || e, T = w;
                        b.fillStyle = e;
                        b.strokeStyle = w;
                        ...
                        for (var Z = !0, p = 0; p < r.length; p++) {
                            var f = r[p], ga = null,
                                ga = 0 <= B.dataPointIndexes[f] ? v[B.dataPointIndexes[f]] : {x: f, y: null};
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z))) if ("number" !== typeof ga.y) B.connectNullData || (Z || x) || d(), Z = !0; else {
                                ...
                                h.push({x: g, y: l - ma});
                                A[f] = l - k;
                                x || Z ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || z === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = h.pop(), z = h[h.length - 1], d(), b.moveTo(u.x, u.y), h.push(z), h.push(x), z = B.nullDataLineDashType,
                                    b.setLineDash(S)), b.lineTo(g, k), t && s.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), t && (s.beginPath(), s.moveTo(g, k))), Z = x = !1) : (b.lineTo(g, k), t && s.lineTo(g, k), 0 == p % 250 && (d(), b.moveTo(g, k), t && s.moveTo(g, k), h.push({
                                    x: g,
                                    y: l - ma
                                })));
                                u = {x: g, y: k};
                                p < v.length - 1 && (T !== (v[p].lineColor || w) || z !== (v[p].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({
                                    x: g,
                                    y: l - ma
                                }), T = v[p].lineColor || w, b.strokeStyle = T, b.setLineDash && (v[p].lineDashType ? (z = v[p].lineDashType, b.setLineDash(N(z, B.lineThickness))) : (z =
                ...
                W.drawMarkers(n);
                t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(m.x1, m.y1, m.width, m.height), s.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        l.prototype.renderStackedArea100 = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = t ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, n = this.plotArea, m = [], k = [], h = [], r = [], q = [], p = 0, g, l, s, da,
                    u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                b.clip();
                t && (z.beginPath(), z.rect(n.x1, n.y1, n.width,
                    n.height), z.clip());
                for (var e = [], D = 0; D < a.dataSeriesIndexes.length; D++) {
                    var y = a.dataSeriesIndexes[D], B = this.data[y], v = B.dataPoints;
                    B.dataPointIndexes = [];
                    for (p = 0; p < v.length; p++) y = v[p].x.getTime ? v[p].x.getTime() : v[p].x, B.dataPointIndexes[y] = p, e[y] || (r.push(y), e[y] = !0);
                    r.sort(Qa)
                }
                for (D = 0; D < a.dataSeriesIndexes.length; D++) {
                    ...
                    if (0 < r.length) {
                        var e =
                            B._colorSet[p % B._colorSet.length], w = B.lineColor = B.options.lineColor || e, T = w;
                        b.fillStyle = e;
                        b.strokeStyle = w;
                        b.lineWidth = B.lineThickness;
                        u = "solid";
                        ...
                        for (var Z = !0, p = 0; p < r.length; p++) {
                            var f = r[p], ga = null,
                                ga = 0 <= B.dataPointIndexes[f] ? v[B.dataPointIndexes[f]] : {x: f, y: null};
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z))) if ("number" !== typeof ga.y) B.connectNullData ||
                            (Z || da) || d(), Z = !0; else {
                                var ma;
                                ...
                                h.push({x: g, y: x - F});
                                k[f] = x - l;
                                da || Z ? (!da && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || u === B.lineDashType &&
                                    B.lineDashType !== B.nullDataLineDashType) && (da = h.pop(), u = h[h.length - 1], d(), b.moveTo(s.x, s.y), h.push(u), h.push(da), u = B.nullDataLineDashType, b.setLineDash(S)), b.lineTo(g, l), t && z.lineTo(g, l)) : (b.beginPath(), b.moveTo(g, l), t && (z.beginPath(), z.moveTo(g, l))), Z = da = !1) : (b.lineTo(g, l), t && z.lineTo(g, l), 0 == p % 250 && (d(), b.moveTo(g, l), t && z.moveTo(g, l), h.push({
                                    x: g,
                                    y: x - F
                                })));
                                s = {x: g, y: l};
                                ...
                                0 <= B.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < B.markerSize) && (F = B.getMarkerProperties(p, g, l, b), m.push(F), f = Q(G),
                                t && m.push({
                                    x: g,
                                    y: l,
                                    ctx: z,
                ...
                W.drawMarkers(m);
                t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation =
        ...
        l.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) for (var r = a.dataSeriesIndexes[h], q = this.data[r], p = q.dataPoints,
                                                                                                           g = 0, e = 0; e < p.length; e++) f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[e].z || (g = p[e].z, g > m && (m = g), g < k && (k = g));
        ...
        l.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var k = a.dataSeriesIndexes[m], h = this.data[k], r = h.dataPoints;
                    if (0 < r.length) {
                        c.strokeStyle = "#4572A7 ";
                        ...
                        for (var q = 0, p = 0, e = 0; e < r.length; e++) if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
                            ...
                            c.globalAlpha = 1;
                            Math.sqrt((q - f) * (q - f) + (p - n) * (p - n)) < Math.min(g.size, 5) && r.length > Math.min(this.plotArea.width,
                                this.plotArea.height) || (q = h.dataPointIds[e], this._eventManager.objectMap[q] = {
                                id: q,
                                objectType: "dataPoint",
                                dataSeriesIndex: k,
                                dataPointIndex: e,
        ...
        l.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, n = this.plotArea, m = 0, k, h, r, q, p, g,
                    ...
                    f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                        this.dataPointWidth : 0.015 * this.width, l = a.axisX.dataInfo.minDiff;
                ...
                for (var fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
                    var da = a.dataSeriesIndexes[fa], u = this.data[da], x = u.dataPoints;
                    if (0 < x.length) for (var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++) if (x[m].getTime ? g = x[m].x.getTime() : g = x[m].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] &&
                    "number" === typeof x[m].y[1] && "number" === typeof x[m].y[2] && "number" === typeof x[m].y[3]) {
                        ...
                        var v = k - l / 2 << 0, y = v + l << 0,
                            f = u.options.fallingColor ? u.fallingColor : u._colorSet[0],
                            e = x[m].color ? x[m].color : u._colorSet[0], B = Math.round(Math.max(1, 0.15 * l)),
                            w = 0 === B % 2 ? 0 : 0.5, E = u.dataPointIds[m];
                        ...
                        "candlestick" === u.type ? (c.moveTo(k - w, r), c.lineTo(k - w, Math.min(h, p)), c.stroke(), c.moveTo(k - w, Math.max(h, p)), c.lineTo(k - w, q), c.stroke(), ba(c, v, Math.min(h, p), y, Math.max(h, p), x[m].y[0] <= x[m].y[3] ? u.risingColor : f, B, e, z, z, !1, !1, u.fillOpacity), t && (e = Q(E), b.strokeStyle = e, b.moveTo(k - w, r), b.lineTo(k - w, Math.min(h,
                        ...
                        (x[m].indexLabel || u.indexLabel ||
                            x[m].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                            chartType: u.type,
                            dataPoint: x[m],
                            dataSeries: u,
                            point: {x: v + (y - v) / 2, y: a.axisY.reversed ? q : r},
                            direction: 1,
                            bounds: {x1: v, y1: Math.min(r, q), x2: y, y2: Math.max(r, q)},
                            color: e
                        })
                    }
                }
                ...
                this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(n.x1, n.y1, n.width, n.height), b.restore());
                c.restore();
                return {
                    source: d,
                    dest: this.plotArea.ctx,
        ...
        l.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                n && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
                ...
                for (var fa = !1, fa = !!a.axisY.reversed, da = 0; da < a.dataSeriesIndexes.length; da++) {
                    ...
                    if (0 < z.length) for (var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0; n < z.length; n++) if (z[n].getTime ? g = z[n].x.getTime() : g = z[n].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[n].y) && z[n].y.length && "number" === typeof z[n].y[0] && "number" === typeof z[n].y[1] && "number" === typeof z[n].y[2] && "number" === typeof z[n].y[3] && "number" === typeof z[n].y[4] && 5 === z[n].y.length) {
                        ...
                        var y = m - l / 2 << 0, B = m + l / 2 << 0, e = z[n].color ? z[n].color : x._colorSet[0],
                            w = Math.round(Math.max(1, 0.15 * l)), E = 0 === w % 2 ? 0 : 0.5,
                            ...
                            G = 1 === Math.round(Ba) % 2 ? 0.5 : 0, J = z[n].stemDashType ? z[n].stemDashType :
                            x.stemDashType,
                            ...
                            K = 1 === Math.round(M) % 2 ? 0.5 : 0, P = x.upperBoxColor, xa = x.lowerBoxColor,
                            sa = s(x.options.fillOpacity) ? 1 : x.fillOpacity, O = x.dataPointIds[n];
                        ...
                        c.restore();
                        c.save();
                        0 < S && (c.beginPath(), c.setLineDash && c.setLineDash(N(F, S)), c.strokeStyle = T, c.lineWidth = S, c.moveTo(m - Z / 2 << 0, q - ga), c.lineTo(m + Z / 2 << 0, q - ga),
                            c.stroke(), c.moveTo(m - Z / 2 << 0, k + ga), c.lineTo(m + Z / 2 << 0, k + ga), c.stroke());
                        c.restore();
                        ...
                        (z[n].indexLabel || x.indexLabel || z[n].indexLabelFormatter ||
                            ...
                            direction: 1,
                            bounds: {x1: y, y1: Math.min(k, q), x2: B, y2: Math.max(k, q)},
                            color: e
                        })
                    }
                }
        ...
        l.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, n, m, k,
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                        1;
                ...
                !this.dataPointMaxWidth &&
                (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
                h < f && (h = f);
                h > n && (h = n);
                c.save();
                t && this._eventManager.ghostCtx.save();
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var q = a.dataSeriesIndexes[r], p = this.data[q], g = p.dataPoints;
                    if (0 < g.length) for (var l =
                        ...
                        var fa = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + r) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount +
                            r) * h << 0, v = a.axisX.reversed ? fa - h << 0 : fa + h << 0,
                        ...
                        if (g[f].indexLabel || p.indexLabel || g[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
                            ...
                            dataSeries: p,
                            indexKeyword: 0,
                            point: {x: fa + (v - fa) / 2, y: g[f].y[1] >= g[f].y[0] ? m : n},
                            direction: g[f].y[1] >= g[f].y[0] ? -1 : 1,
                            bounds: {x1: fa, y1: Math.min(n, m), x2: v, y2: Math.max(n, m)},
                            color: b
                        }), this._indexLabels.push({
                            chartType: "rangeColumn",
                            dataPoint: g[f],
                            dataSeries: p,
                            indexKeyword: 1,
                            point: {x: fa + (v - fa) / 2, y: g[f].y[1] >= g[f].y[0] ? n : m},
                            direction: g[f].y[1] >= g[f].y[0] ? 1 : -1,
                            bounds: {x1: fa, y1: Math.min(n, m), x2: v, y2: Math.max(n, m)},
                            color: b
                        })
        ...
        l.prototype.renderError =
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null, f = !1, n = this.plotArea, m = 0, k, h, r, q, p, g, l, fa = a.axisX.dataInfo.minDiff;
                    ...
                    c.rect(n.x1, n.y1, n.width, n.height);
                    c.clip();
                    t && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(n.x1,
                        n.y1, n.width, n.height), this._eventManager.ghostCtx.clip());
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        var z = a.dataSeriesIndexes[x], D = this.data[z], y = D.dataPoints,
                            B = s(D._linkedSeries) ? !1 : D._linkedSeries.type.match(/(bar|column)/ig) && D._linkedSeries.visible ? !0 : !1,
                            E = 0;
                        if (B) for (e = D._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) ||
                        ...
                        f && (m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                        ...
                        if (0 < y.length) for (var F = D._colorSet, m = 0; m < y.length; m++) {
                            ...
                            if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !s(y[m].y) && y[m].y.length && "number" === typeof y[m].y[0] && "number" === typeof y[m].y[1]) {
                                ...
                                b ? q = ka : g = ka;
                                b ? (p = a.axisX.reversed ? h + (B ? v :
                                    1) * u / 2 - (B ? E - 1 : 0) * u << 0 : h - (B ? v : 1) * u / 2 + (B ? E - 1 : 0) * u << 0, g = a.axisX.reversed ? p - u << 0 : p + u << 0) : (r = a.axisX.reversed ? k + (B ? v : 1) * u / 2 - (B ? E - 1 : 0) * u << 0 : k - (B ? v : 1) * u / 2 + (B ? E - 1 : 0) * u << 0, q = a.axisX.reversed ? r - u << 0 : r + u << 0);
                                !b && p > g && (ka = p, p = g, g = ka);
                                b && r > q && (ka = r, r = q, q = ka);
                                ka = D.dataPointIds[m];
                                ...
                                w(c, Math.min(r, q),
                                    Math.min(p, g), Math.max(q, r), Math.max(g, p), e, T, S, b);
                    ...
                    a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(n.x1, n.y1, n.width, n.height), this._eventManager.ghostCtx.restore());
                    c.restore();
                    return {
                        source: d,
                        dest: this.plotArea.ctx,
        ...
        l.prototype.renderRangeBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    var p = a.dataSeriesIndexes[q], g = this.data[p], l = g.dataPoints;
                    if (0 < l.length) {
                        ...
                        for (f = 0; f < l.length; f++) if (l[f].getTime ? h = l[f].x.getTime() : h = l[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(l[f].y) && l[f].y.length && "number" === typeof l[f].y[0] && "number" === typeof l[f].y[1]) {
                            ...
                            if (l[f].indexLabel || g.indexLabel || l[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({
                                ...
                                dataSeries: g,
                                indexKeyword: 0,
                                point: {x: l[f].y[1] >= l[f].y[0] ? n : m, y: k + (v - k) / 2},
                                direction: l[f].y[1] >= l[f].y[0] ? -1 : 1,
                                bounds: {x1: Math.min(n, m), y1: k, x2: Math.max(n, m), y2: v},
                                color: b
                            }), this._indexLabels.push({
                                chartType: "rangeBar",
                                dataPoint: l[f],
        ...
        l.prototype.renderRangeArea = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = t ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = [], n = this.plotArea;
                b.save();
                t && e.save();
                b.beginPath();
                b.rect(n.x1, n.y1, n.width, n.height);
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var k =
                        [], h = a.dataSeriesIndexes[m], r = this.data[h], q = r.dataPoints, f = r.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: h};
                    f = Q(f);
                    e.fillStyle = f;
                    var f = [], p = !0, g = 0, l, s, v, u, x = null;
                    if (0 < q.length) {
                        var z = r._colorSet[g % r._colorSet.length], D = r.lineColor = r.options.lineColor || z, y = D;
                        b.fillStyle = z;
                        b.strokeStyle = D;
                        b.lineWidth = r.lineThickness;
                        var B = "solid";
                        ...
                        q.length; g++) if (u = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !T))) if (null !== q[g].y && q[g].y.length && "number" === typeof q[g].y[0] && "number" === typeof q[g].y[1]) {
                            ...
                            p || T ? (r.connectNullData && !p ? (b.setLineDash && (r.options.nullDataLineDashType || B === r.lineDashType && r.lineDashType !== r.nullDataLineDashType) && (k[k.length -
                            1].newLineDashArray = E, B = r.nullDataLineDashType, b.setLineDash(w)), b.lineTo(l, s), t && e.lineTo(l, s), k.push({
                                x: l,
                                y: v
                            })) : (b.beginPath(), b.moveTo(l, s), x = {x: l, y: s}, k = [], k.push({
                                x: l,
                                y: v
                            ...
                            g < q.length - 1 && (y !== (q[g].lineColor || D) || B !== (q[g].lineDashType || r.lineDashType)) && (d(),
                                y = q[g].lineColor || D, k[k.length - 1].newStrokeStyle = y, b.strokeStyle = y, b.setLineDash && (q[g].lineDashType ? (B = q[g].lineDashType, k[k.length - 1].newLineDashArray = N(B, r.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (B = r.lineDashType, k[k.length - 1].newLineDashArray = E, b.setLineDash(E))));
                ...
                t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(n.x1, n.y1,
                    n.width, n.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        l.prototype.renderRangeSplineArea = function (a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    if (0 < h.lineThickness) {
                        ...
                        for (var f = 0; f < d.length - 3; f += 3) {
                            if (d[f].newStrokeStyle || d[f].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x,
                                d[f].y), d[f].newStrokeStyle && (b.strokeStyle = d[f].newStrokeStyle), d[f].newLineDashArray && b.setLineDash(d[f].newLineDashArray);
                    ...
                    d = v(da, 2);
                    b.lineTo(da[da.length - 1].x, da[da.length -
                    1].y);
                    ...
                    if (0 < h.lineThickness) {
                        ...
                        for (var g = f = 0; f < d.length - 3; f += 3, g++) {
                            if (s[g].newStrokeStyle || s[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x,
                                d[f].y), s[g].newStrokeStyle && (b.strokeStyle = s[g].newStrokeStyle), s[g].newLineDashArray && b.setLineDash(s[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        b.stroke()
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.rect(n.x1, n.y1, n.width, n.height);
                b.clip();
                t && (e.beginPath(), e.rect(n.x1, n.y1, n.width,
                    n.height), e.clip());
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var k = a.dataSeriesIndexes[m], h = this.data[k], r = h.dataPoints, f = h.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: k};
                    f = Q(f);
                    e.fillStyle = f;
                    var f = [], q = 0, p, g, l, s = [], da = [];
                    if (0 < r.length) {
                        var u = h._colorSet[q % h._colorSet.length], x = h.lineColor = h.options.lineColor || u, z = x;
                        b.fillStyle = u;
                        b.lineWidth = h.lineThickness;
                        var D = "solid", y;
                        if (b.setLineDash) {
                            var B = N(h.nullDataLineDashType, h.lineThickness), D = h.lineDashType;
                            y = N(D,
                                h.lineThickness)
                        }
                ...
                t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0,
                    this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(n.x1, n.y1, n.width, n.height), this._eventManager.ghostCtx.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
        ...
        l.prototype.renderWaterfall = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx,
                c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, n = 0, m, k, h, r,
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var l = a.dataSeriesIndexes[g], s = this.data[l], v = s.dataPoints, e = s._colorSet[0];
                    ...
                    if (0 < v.length) for (var z = 5 < p && s.bevelEnabled ? !0 : !1, D = !1, y = null, B = null, n = 0; n < v.length; n++) if (v[n].getTime ? r = v[n].x.getTime() : r = v[n].x, "number" !== typeof v[n].y) {
                        ...
                        0 < n && y && (!D || s.connectNullData) && (D && c.setLineDash && c.setLineDash(N(w, u)), c.beginPath(), c.moveTo(y, B - x), c.lineTo(T, S - x), 0 < u && c.stroke(), t &&
                        (b.beginPath(), b.moveTo(y, B - x), b.lineTo(T, S - x), 0 < u && b.stroke()));
                        D = !1;
                        y = E;
                        B = 0 < v[n].y ? k : h;
                        ...
                        (v[n].indexLabel || s.indexLabel || v[n].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            bounds: {x1: m, y1: Math.min(k, h), x2: E, y2: Math.max(k, h)},
                            color: e
                        })
                    }
                }
        ...
        var Y = function (a, d, c, b, e, f, n, m, k) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = m;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, n, !1), a.fillStyle = b, a.strokeStyle =
                    "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, n, !1), 0 <= k && a.arc(d.x, d.y, k * c, n, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
        l.prototype.renderPie = function (a) {
            function d() {
                if (h && r) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < r.length; e++) {
                        var f = r[e], n = h.dataPointIds[e];
                        g[e].id = n;
                        g[e].objectType = "dataPoint";
                        g[e].dataPointIndex = e;
                        g[e].dataSeriesIndex = 0;
                        var m = g[e], q = {percent: null, total: null}, l = null, q = k.getPercentAndTotal(h,
                            f);
                        ...
                        m.indexLabelMaxWidth =
                            f.indexLabelMaxWidth ? f.indexLabelMaxWidth : h.indexLabelMaxWidth ? h.indexLabelMaxWidth : 0.33 * p.width;
            ...
            function c(a) {
                ...
                for (b = 0; b < r.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * B * Math.cos(g[b].midAngle), f = 0.07 * B * Math.sin(g[b].midAngle), m = !1;
                        if (r[b].exploded) {
                            if (1E-9 < Math.abs(g[b].center.x - (z.x + e)) || 1E-9 < Math.abs(g[b].center.y - (z.y + f))) g[b].center.x = z.x + e * a, g[b].center.y = z.y + f * a, m = !0
                        } else if (0 < Math.abs(g[b].center.x - z.x) || 0 < Math.abs(g[b].center.y - z.y)) g[b].center.x = z.x +
                            e * (1 - a), g[b].center.y = z.y + f * (1 - a), m = !0;
                ...
                a.lineJoin = "round";
                for (b = b = 0; b < r.length; b++) c = g[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d =
                    ...
                    a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(N(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -q : q), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                a.save()
            }
            ...
            function b(a, b) {
                var c = 0, c = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height / 2,
                    ...
                    e = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height /
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < r.length) {
                    ...
                    0 > c ? k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 > m && k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + c < m && (c = -(m - (k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 + c))) : k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 < m && k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + c > n && (c = k.indexLabelTextBlock.y +
                        k.indexLabelTextBlock.height / 2 + c - n);
                    ...
                    for (n = 1; n < r.length; n++) if (m = (a - n + g.length) % g.length, g[m].hemisphere !== g[a].hemisphere) {
                        m = null;
                        break
                    } else if (g[m].indexLabelText &&
                        g[m].hemisphere === g[a].hemisphere && m !== a && (0 > b(g[m], g[a]) || ("right" === g[a].hemisphere ? g[m].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[m].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break; else m = null;
                    q = m;
                    p = e(a);
                    n = m = 0;
                    0 > c ? (n = "right" === k.hemisphere ? q : p, h = c, null !== n && (q = -c, c = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (g[n].indexLabelTextBlock.y + g[n].indexLabelTextBlock.height / 2), c - q < l && (m = -q, n = f(n, m, d + 1), +n.toFixed(x) > +m.toFixed(x) && (h = c > l ? -(c - l) : -(q - (n - m)))))) : 0 < c && (n = "right" ===
                    k.hemisphere ? p : q, h = c, null !== n && (q = c, c = g[n].indexLabelTextBlock.y - g[n].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2), c - q < l && (m = q, n = f(n, m, d + 1), +n.toFixed(x) < +m.toFixed(x) && (h = c > l ? c - l : q - (m - n)))));
                    h && (d = k.indexLabelTextBlock.y + h, c = 0, c = "right" === k.hemisphere ? z.x + Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)), k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (m = (a - 1 + g.length) % g.length, m = g[m], a = g[(a + 1 + g.length) % g.length], "left" ===
            ...
            function n() {
                ...
                for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                        ...
                        for (var u, s, a = 0; a < r.length; a++) {
                            ...
                            if (null !== y) {
                                ...
                                if (0 > D) {
                                    ...
                                    s = D / (s + F || 1) * F;
                                    var F = -1 * (D - s), I = J = 0;
                                    "right" === n.hemisphere ? (J = f(a, s), F = -1 * (D - J), I = f(y, F), +I.toFixed(x) <
                    ...
                    for (a = 0; a < r.length; a++) if (n = g[a], y = n.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) y = y = 0, "right" === n.hemisphere ? (y = p.x2 - (n.indexLabelTextBlock.x + n.indexLabelTextBlock.width +
                            ...
                            if (null !== n) {
                                ...
                                if (k = 0 > D) {
                                    ...
                                    var p = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height /
                                        2, l = u.indexLabelTextBlock.y + u.indexLabelTextBlock.height / 2,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h =
                        this.data[a.dataSeriesIndexes[0]], r = h.dataPoints, q = 10, p = this.plotArea, g = h.dataPointEOs,
                    l = 2, t, v = 1.3, u = 20 / 180 * Math.PI, x = 6, z = {x: (p.x2 + p.x1) / 2, y: (p.y2 + p.y1) / 2},
                    D = 0;
                a = !1;
                ...
                if (0 !== D) {
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                        ...
                        for (b = 0; b < r.length; b++) {
                            ...
                            d > c && Y(k.plotArea.ctx,
                                g[b].center, g[b].radius, f, h.type, c, d, h.fillOpacity, g[b].percentInnerRadius);
                            if (e) break
                        }
                        m()
                    }, function () {
        ...
        var qa = function (a, d, c, b) {
            ...
            0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2), Math.round(d.y2)), a.lineTo(Math.round(d.x3), Math.round(d.y3)), a.lineTo(Math.round(d.x4), Math.round(d.y4)), "undefined" !==
        ...
        l.prototype.renderFunnel = function (a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var n = d[0] = 0, m = 0, k, r, b = b - a, n = !1, h = 0; h < x.length; h++) a = Math.abs(x[h].y) * f / g, n ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (r = aa * aa * b * b - 4 * Math.abs(aa) * a, 0 > r ? (r = c, n = (b + r) * (e - m) / 2, a -= n, k = e - m, m += e - m, k += 0 == r ? 0 : a / r, m += a / r, n = !0) : (k = (Math.abs(aa) * b - Math.sqrt(r)) / 2, r = b - 2 * k / Math.abs(aa), m += k, m > e && (m -= k, r =
                    c, n = (b + r) * (e - m) / 2, a -= n, k = e - m, m += e - m, k += a / r, m += a / r, n = !0), b = r)), d.push(k);
                return d
            }
            ...
            function b() {
                if (u && x) {
                    ...
                    for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++, B--) {
                        ...
                        k = "number" === typeof b.indexLabelLineThickness ?
                        ...
                        "inside" === u.indexLabelPlacement && (A[y] = y !== ba ? u.reversed ? O[y].x2 - O[y].x1 :
                            O[y].x3 - O[y].x4 : O[y].x3 - O[y].x6, 20 > A[y] && (A[y] = y !== ba ? u.reversed ? O[y].x3 - O[y].x4 : O[y].x2 - O[y].x1 : O[y].x2 - O[y].x1, A[y] /= 2));
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(z) : b.indexLabel ?
                            w.replaceKeywordsWithValue(b.indexLabel, b, u, y) : u.indexLabelFormatter ? u.indexLabelFormatter(z) : u.indexLabel ? w.replaceKeywordsWithValue(u.indexLabel, b, u, y) : b.label ? b.label : "";
                        0 >= k && (k = 0);
            ...
            function e() {
                ...
                if (e) for (m = H.length - 1; 0 <= m; m--) a = O[m], H[m].textBlock.maxWidth =
            ...
            function n() {
                ...
                function b() {
                    ...
                    for (var m, n = 1; n < h; n++) {
                        e = n * f;
                        for (var r = H.length - 1; 0 <= r; r--) !H[r].isDirty && (H[r].textBlock.y <
                ...
                for (var d, e, f, g, h, n, k = 1, r = 0; r < 2 * k; r++) {
                    for (var l = H.length - 1; 0 <= l && !(0 <= q(l) && q(l), f = H[l], g = f.textBlock,
                        n = (h = p(l) < O.length ? H[p(l)] : null) ? h.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (h && e + d + ca > +n.y.toFixed(6)) && (d = g.y + d + ca - n.y, e = a(l, -d), e < d && (0 < e && (d -= e), e = a(p(l), d), e != d))); l--) ;
                    b()
                }
            }
            ...
            function v(a) {
                ...
                if (w.subtitles) for (var b = 0; b < w.subtitles.length; b++) {
                    var c = w.subtitles[b];
                    if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) w.subtitles.ctx =
                        a, c.render()
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, D = 0.025 * z.width, y = 0.01 * z.width, B = 0, E = z.height - 2 * D, F = Math.min(z.width - 2 * y, 2.8 * z.height), I = !1, S = 0; S < x.length; S++) if (!I && ("undefined" !== typeof x[S].indexLabel && null !== x[S].indexLabel &&
                    0 < x[S].indexLabel.toString().length) && (I = !0), !I && ("undefined" !== typeof x[S].label && null !== x[S].label && 0 < x[S].label.toString().length) && (I = !0), !I && "function" === typeof u.indexLabelFormatter || "function" === typeof x[S].indexLabelFormatter) I = !0;
                ...
                var S = z.x1 + y, M = z.x2 - y, Z = z.y1 + D, R = z.y2 - D,
                ...
                if (0 != u.length && (u.dataPoints &&
                    ...
                    var y = S + a / 2, X = S, $ = S + a, na = u.reversed ? R : Z, K = y - G / 2, W = y + G / 2,
                        xa = u.reversed ? Z + P : R - P,
                        sa = u.reversed ? Z : R;
                    a = [];
                    var y = [], O = [], F = [], U = Z, ba, aa = (xa - na) / (K - X), ea = -aa,
                    ...
                    if (-1 !== S) {
                        ...
                        var ca = 2, H = [], ia = !1, Y = [], ha = [], S = !1;
                        a = a = 0;
                        Da(Y);
                        for (G = 0; G < x.length; G++) x[G].exploded &&
                        ...
                        for (G = 0; G < O.length; G++) B = O[G], qa(Q, B, u.fillOpacity),
                            ha.push(B.y1);
                        v(Q);
                        ...
                        this.funnelPyramidClickHandler = function (a) {
                            var b = -1;
                            if (!ia && !w.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                                (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                a = b;
        ...
        l.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var n = "#percent", m = "#total", k = this.getPercentAndTotal(c, d), m = isNaN(k.total) ? m : k.total,
                    n = isNaN(k.percent) ? n : k.percent;
                do {
                    k = "";
                    if (c.percentFormatString) k = c.percentFormatString;
                    else {
                        var k = "#,##0.", h = Math.max(Math.ceil(Math.log(1 / Math.abs(n)) / Math.LN10), 2);
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                } else return ea(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString :
        ...
        F.prototype.setLayout = function () {
            ...
            this.height = 0;
            var k = [], h = [];
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (this.orientation = "horizontal", c = this.verticalAlign, f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width, n = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical", c = this.horizontalAlign,
            ...
            for (var r = 0; r < this.dataSeries.length; r++) {
                ...
                if (q.dataPoints && q.dataPoints.length) if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                    var p = q.legendMarkerType = q.legendMarkerType ? q.legendMarkerType : "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type || !q.markerType ?
                        "error" === q.type && q._linkedSeries ? q._linkedSeries.legendMarkerType ? q._linkedSeries.legendMarkerType : I.getDefaultLegendMarker(q._linkedSeries.type) : I.getDefaultLegendMarker(q.type) : q.markerType,
                    ...
                    var z = q.dataPoints[x],
                        ...
                        g = z.legendText ? z.legendText : q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            ...
                            dataSeries: q,
                            dataPoint: z
                        }) : z.name ? z.name : "DataPoint: " + (x + 1), l = z.legendMarkerColor ? z.legendMarkerColor :
                        q.legendMarkerColor ? q.legendMarkerColor : z.color ? z.color : q.color ? q.color : q._colorSet[x % q._colorSet.length],
            ...
            if (0 < k.length) {
                q = null;
                l = g = z = x = 0;
                z = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth =
                    f;
        ...
        F.prototype.render = function () {
            ...
            for (var m = 0, k = 0; k < n.length; k++) {
                for (var h = n[k], r = 0, q = 0; q < h.items.length; q++) {
                    ...
                    this.ctx.clip();
                    if ("line" === p.chartType || "stepLine" === p.chartType || "spline" === p.chartType) this.ctx.strokeStyle = p.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, l + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, l + this.lineHeight / 2), this.ctx.stroke(), s -=
                        0.1 * this.lineHeight;
                    if ("error" === p.chartType) {
                        this.ctx.strokeStyle = this.errorMarkerColor[0];
                        this.ctx.lineWidth = f / 8;
                        this.ctx.beginPath();
                        var t = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = l + 0.15 * this.lineHeight,
                            v = 0.7 * this.lineHeight, z = v + 0.02 * this.lineHeight;
                        this.ctx.moveTo(t, u);
                    ...
                    W.drawMarker(g +
                        f / 2, l + this.lineHeight / 2, this.ctx, p.markerType, "error" === p.chartType || "line" === p.chartType || "spline" === p.chartType ? p.markerSize / 2 : p.markerSize, p.markerColor, p.markerBorderColor, p.markerBorderThickness);
                    p.textBlock.x = g + c + f;
                    ...
                    p.y2 = this.chart._eventManager.objectMap[p.id].y2 = p.textBlock.y + p.textBlock.height - this.lineHeight /
                        2
                }
                m += r
            }
        ...
        I.prototype.getDataPointAtX = function (a, d) {
            ...
            var c = {
                ...
                index: NaN
            }, b = null, e = 0, f = 0, n = 1, m = Infinity, k = 0, h = 0, r = 0;
        ...
        I.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            c = c || !1;
            var b = [], e = 0, f = 0, n = 1, m = !1, k = Infinity, h = 0, r = 0, q = 0;
            if ("none" !== this.chart.plotInfo.axisPlacement) if (q = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
                ...
                q = 1 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * Math.log(q /
                    this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else p = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, q = 0 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * (q - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
            for (; ;) {
                f = 0 < n ? q + e : q - e;
                if (0 <= f && f < this.dataPoints.length) {
                    var p = this.chart._eventManager.objectMap[this.dataPointIds[f]], g = this.dataPoints[f], l = null;
                    if (p) {
                        switch (this.type) {
                            case "column":
                            case "stackedColumn":
                            ...
                            case "error":
                                a >=
                                p.x1 && (a <= p.x2 && d >= p.y1 && d <= p.y2) && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                            ...
                            case "splineArea":
                            case "scatter":
                                var s = la("markerSize", g, this) || 4, t = c ? 20 : s,
                                    l = Math.sqrt(Math.pow(p.x1 - a, 2) + Math.pow(p.y1 - d, 2));
                                l <= t && b.push({dataPoint: g, dataPointIndex: f, dataSeries: this, distance: l});
                                p =
                                    Math.abs(p.x1 - a);
                                p <= k ? k = p : 0 < n ? h++ : r++;
                                l <= s / 2 && (m = !0);
                            ...
                            case "boxAndWhisker":
                                if (a >=
                                    p.x1 - p.borderThickness / 2 && a <= p.x2 + p.borderThickness / 2 && d >= p.y4 - p.borderThickness / 2 && d <= p.y1 + p.borderThickness / 2 || Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness && d >= p.y1 && d <= p.y4) b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                ...
                                break;
                            case "candlestick":
                                if (a >= p.x1 - p.borderThickness / 2 && a <= p.x2 + p.borderThickness / 2 && d >= p.y2 - p.borderThickness / 2 && d <= p.y3 + p.borderThickness / 2 || Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness &&
                                    d >= p.y1 && d <= p.y4) b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: Math.min(Math.abs(p.x1 - a), Math.abs(p.x2 - a), Math.abs(p.y2 - d), Math.abs(p.y3 - d))
                            ...
                            case "ohlc":
                                if (Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness && d >= p.y2 && d <= p.y3 || a >= p.x1 && a <= (p.x2 + p.x1) / 2 && d >= p.y1 - p.borderThickness / 2 && d <= p.y1 + p.borderThickness / 2 || a >= (p.x1 + p.x2) / 2 && a <= p.x2 && d >= p.y4 - p.borderThickness / 2 && d <= p.y4 + p.borderThickness / 2) b.push({
                                    ...
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: Math.min(Math.abs(p.x1 - a),
        ...
        E.prototype.createLabels = function () {
            var a, d, c = 0, b = 0, e, f = 0, n = 0, b = 0, b = this.interval, m = 0, k, h = 0.6 * this.chart.height, l;
            a = !1;
            var q = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
                p = q.length ? s(this.scaleBreaks.firstBreakIndex) ?
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = p; b < this.logLabelValues.length; b++) if (c =
                ...
                a || (a = this.labelFormatter ? this.labelFormatter({
                    ...
                    this.labels[l] : Aa(l, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
                    x: 0,
                    y: 0,
                    maxWidth: f,
                    backgroundColor: this.labelBackgroundColor,
            ...
            e = [];
            p = q = 0;
            if (this.labelAutoFit || this.options.labelAutoFit) if (s(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (f = 0.9 * m >> 0, p = 0, !this.chart.panEnabled &&
            1 <= this._labels.length) {
                ...
                for (c = 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
                    ...
                    for (var v, g = a.text.split(" "), b = 0; b < g.length; b++) l = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, l = this.ctx.measureText(l),
                ...
                this.sessionVariables.labelMaxHeight = n : this.sessionVariables.labelMaxHeight, a.measureText();
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("left" === this._position || "right" === this._position) w = s(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight :
                ...
                a = new ja(this.ctx, {
                    ...
                    fontFamily: "outside" ===
                    f.labelPlacement ? f.options.labelFontFamily ? f.labelFontFamily : this.labelFontFamily : f.labelFontFamily,
        ...
        E.setLayout = function (a, d, c, b, e, f) {
            var n, m, k, h, l = a[0] ? a[0].chart : d[0].chart, q = l.isNavigator ? 0 : 10, p = l._axes;
            ...
            for (g = 0; g < p.length; g++) if (p[g] && p[g].scaleBreaks && p[g].scaleBreaks._appliedBreaks.length) for (var t = p[g].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > p[g].viewportMaximum); v++) t[v].endValue < p[g].viewportMinimum || (s(p[g].scaleBreaks.firstBreakIndex) && (p[g].scaleBreaks.firstBreakIndex =
                v), t[v].startValue >= p[g].viewPortMinimum && (p[g].scaleBreaks.lastBreakIndex = v));
            ...
            if ("normal" === e) {
                for (var x = [], z = [], D = [], y = [], M = [], N = [], P = [], Q = []; 4 > v;) {
                    var G = 0, R = 0, V = 0, Y = 0, X = e = 0, K = 0, $ = 0, U = 0, W = 0, O = 0, aa = 0;
                    ...
                    P.push(D);
                    if (b &&
                        0 < b.length) for (y = [], g = aa = 0; g < b.length; g++) y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), aa += y[g], $ += b[g] ? b[g].margin : 0; else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    Q.push(y);
                    n = Math.round(f.x1 + O + K);
                    k = Math.round(f.x2 - aa - $ > l.width - q ? l.width - q : f.x2 - aa - $);
                    if (a && 0 < a.length) for (x = [], g = U = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(k - n), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ?
                        a[g].titleMaxWidth : a[g].lineCoordinates.width), x.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), U += x[g], e += a[g] && !l.isNavigator ? a[g].margin : 0; else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                    M.push(x);
                    if (d && 0 < d.length) for (z = [], g = W = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(k - n), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width),
                        z.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), W += z[g], X += d[g] && !l.isNavigator ? d[g].margin : 0; else z.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    N.push(z);
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = n, k = Math.round(f.x2 - aa - $ > l.width - q ? l.width - q : f.x2 - aa - $), a[g]._labels && 1 < a[g]._labels.length && (m = h = 0, h = a[g]._labels[1], m = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI /
                        ...
                        a[g].lineThickness / 2), a[g].bounds = {
                        x1: n,
                        y1: m,
                        x2: k,
                        y2: h - (U + e - x[g] - G),
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > l.width - q ? l.width - q : f.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(k - n), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], m = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI /
                        ...
                        m + W + X - R, d[g].lineCoordinates.y2 = m, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - z[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)), d[g].bounds = {
                        x1: n,
                        y1: m + (W + X - z[g] - R),
                        x2: k,
                        y2: h,
                    ...
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) K = l.isNavigator ? 0 : 10, c[g] && (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : q, m = Math.round(f.y1 +
                    W + X < Math.max(K, q) ? Math.max(K, q) : f.y1 + W + X), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : q, h = Math.round(f.y2 - U - e - K), c[g].lineCoordinates = {
                        x1: n - V,
                        y1: m,
                        x2: k - V,
                        y2: h,
                        height: Math.abs(h - m)
                    }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (D[g] - c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.x2 =
                        c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = {
                        x1: n - (D[g] + V),
                        y1: m,
                        x2: k,
                        y2: h,
                    ...
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && (n = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(n), K = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height /
                        2 : 0, m = Math.round(f.y1 + W + X < Math.max(K, q) ? Math.max(K, q) : f.y1 + W + X), K = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, h = Math.round(f.y2 - (U + e + K)), b[g].lineCoordinates = {
                        x1: n + Y,
                        y1: m,
                        x2: n + Y,
                        y2: h,
                        height: Math.abs(h - m)
                    }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (y[g] - b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness /
                        2), b[g].bounds = {
                        x1: n,
                        y1: m,
                        x2: k + (y[g] + Y),
                    ...
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (B = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase :
                    ...
                    if (d && 0 < d.length) for (g =
                        ...
                        n), E = d[g].logarithmic ? (1 < n ? Math.log(n) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < n ? n * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    ...
                    if (0 < v) {
                        ...
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = N[v -
                        1][g] === N[v][g] ? !0 : !1; else I = !0;
                ...
                for (N = []; 4 > v;) {
                    ...
                    M.push(F);
                    if (d && 0 < d.length) for (w = [], g = U = 0; g < d.length; g++) w.push(Math.ceil(d[g] ?
                        d[g].createLabelsAndCalculateWidth() : 0)), U += w[g], X += d[g] ? d[g].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                    N.push(w);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, n = Math.round(f.x1 + Y + e), k = Math.round(f.x2 - U - X > l.width - 10 ? l.width - 10 : f.x2 - U - X), c[g].labelAutoFit && !s(x) && (0 < !a.length && (n = 0 > c[g].labelAngle ? Math.max(n, x) : 0 === c[g].labelAngle ? Math.max(n, x / 2) : n), 0 < !d.length && (k = 0 < c[g].labelAngle ? k - z / 2 : 0 === c[g].labelAngle ? k - z / 2 : k)), c[g].lineCoordinates.x1 = n, c[g].lineCoordinates.x2 =
                        k, c[g].lineCoordinates.width = Math.abs(k - n), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, n = Math.round(f.x1 + Y + e), k = Math.round(f.x2 - U - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - X), b[g] && b[g].labelAutoFit && !s(D) && (0 < !a.length && (n = 0 < b[g].labelAngle ? Math.max(n, D) : 0 === b[g].labelAngle ? Math.max(n, D / 2) : n), 0 < !d.length && (k -= y / 2)),
                        b[g].lineCoordinates.x1 = n, b[g].lineCoordinates.x2 = k, b[g].lineCoordinates.width = Math.abs(k - n), b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                    ...
                    E.push(q);
                    if (b && 0 < b.length) for (B = [],
                                                    g = R = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), R += B[g], $ += b[g].margin; else B.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(B);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (h = c[g]._labels[0], m = c[g]._labels[c[g]._labels.length - 1], x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), z = m.textBlock.width * Math.cos(Math.PI /
                        180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0], m = b[g]._labels[b[g]._labels.length - 1], D = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), y = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height -
                        m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
                    ...
                    if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--) m = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = m - (q[g] + c[g].margin + W), c[g].lineCoordinates.y2 = m - (q[g] + c[g].margin +
                        W), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + q[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
                        x1: n,
                    ...
                    if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) b[g] && (m = Math.round(f.y1), h = Math.round(f.y1 + (B[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                        ...
                        width: k - n,
                        height: R
                    }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth :
                        b[g].lineCoordinates.width), G += B[g] + b[g].margin);
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                        ...
                        h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2 - V) : f.y2 > l.height - Math.max(K, 10) ? l.height -
                            Math.max(K, 10) : f.y2;
                        ...
                        a[g].lineCoordinates = {x1: k - P, y1: m, x2: k - P, y2: h, height: Math.abs(h - m)};
                        "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (F[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height :
                            0)) + ("outside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2);
                        a[g].bounds = {x1: k - (F[g] + P), y1: m, x2: k, y2: h, width: k - n, height: h - m};
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                        K = d[g]._labels &&
                        0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize / 2 : 0;
                        n = Math.round(f.x1 - e);
                        m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1) : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1;
                        ...
                        if (c && 0 < c.length) for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ?
                            Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : n);
                        if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2, n = k - U);
                        d[g].lineCoordinates = {x1: k + Q, y1: m, x2: k + Q, y2: h, height: Math.abs(h - m)};
                        "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (w[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 +
                            d[g].lineThickness / 2);
                        d[g].bounds = {
        ...
        E.render = function (a, d, c, b, e) {
            ...
            d[0] && e.rect(5, d[d.length -
            1].bounds.y1, d[0].chart.width - 10, d[0].bounds.height);
            e.clip();
            ...
            e.clip();
            if (a && 0 <
                a.length) for (m = 0; m < k.length; m++) k[m].renderStripLinesOfThicknessType("value");
            ...
            if (c && 0 < c.length) for (m = 0; m <
            c.length; m++) c[m].renderInterlacedColors();
            ...
            if (b && 0 < b.length) for (m = 0; m < b.length; m++) b[m].renderGrid(),
        ...
        E.prototype.calculateStripLinesThicknessInValues = function () {
            for (var a = 0; a < this.stripLines.length; a++) if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
                ...
                this.stripLines[a].value = this.logarithmic ? this.stripLines[a].value *
                    Math.sqrt(Math.log(this.stripLines[a].endValue / this.stripLines[a].startValue) / Math.log(d)) : this.stripLines[a].value + (Math.abs(this.stripLines[a].endValue - this.stripLines[a].startValue) - d) / 2;
        ...
        E.prototype.calculateBreaksInPixels =
            function () {
                if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                    ...
                    for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++) a[d].endValue < this.conversionParameters.minimum || (s(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d), a[d].startValue >= this.conversionParameters.minimum && (a[d].startPixel = this.convertValueToPixel(a[d].startValue),
        ...
        E.prototype.renderLabelsTicksAndTitle = function () {
            ...
            if ("undefined" === typeof this.options.interval) {
                if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ?
                        1 : 1.2, k, m = this.viewportMaximum, l = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                        q = this._labels[h];
                    ...
                    this.viewportMinimum || (k = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += k);
            ...
            if ("bottom" === this._position) {
                ...
                this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (p.x << 0) + 0.5 : p.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, p.y << 0), this.ctx.lineTo(b, p.y - this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === q.textBlock.angle ? (p.x -= q.textBlock.width / 2, p.y = "inside" === this.labelPlacement ? p.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : p.y - (("inside" === this.tickPlacement ?
                    ...
                    ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : p.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + ((q.textBlock.height - q.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))), q.textBlock.x = p.x, q.textBlock.y = p.y));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
                    for (h = 0; h < a._labels.length; h++) if (q = a._labels[h], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) &&
                    (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
                        a.ctx.lineWidth = a.tickThickness;
                        a.ctx.strokeStyle = a.tickColor;
                        var b = 1 === a.ctx.lineWidth % 2 ? (p.x << 0) + 0.5 : p.x << 0;
                        a.ctx.save();
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
                    for (h = 0; h < a._labels.length; h++) if (q = a._labels[h], !(q.position < a.viewportMinimum ||
                        q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
                        a.ctx.lineWidth = a.tickThickness;
                        a.ctx.strokeStyle = a.tickColor;
                ...
                this.title && (this._titleTextBlock.measureText(), this._titleTextBlock.x = this.bounds.x1 + 1, this._titleTextBlock.y = this.lineCoordinates.height / 2 + this._titleTextBlock.width / 2 +
                ...
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
                    for (h = 0; h < a._labels.length; h++) if (q =
                        a._labels[h], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
                        a.ctx.lineWidth = a.tickThickness;
                        a.ctx.strokeStyle = a.tickColor;
                        var b = 1 === a.ctx.lineWidth % 2 ? (p.y << 0) + 0.5 : p.y << 0;
                        a.ctx.save();
                ...
                this.title && (this._titleTextBlock.measureText(), this._titleTextBlock.x = this.bounds.x2 - 1, this._titleTextBlock.y = this.lineCoordinates.height /
            ...
            }, this); else for (h = 0; h < this._labels.length; h++) q = this._labels[h],
        ...
        E.prototype.renderInterlacedColors = function () {
            ...
            d = !0;
            if (("bottom" === this._position || "top" === this._position) && this.interlacedColor) for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) d ? (d = this.getPixelCoordinatesOnAxis(this._labels[e].position), c = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) :
                this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(Math.min(c.x, d.x), b.y1, Math.abs(c.x - d.x), Math.abs(b.y1 - b.y2)), d = !1) : d = !0; else if (("left" === this._position || "right" === this._position) && this.interlacedColor) for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) d ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position), d = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(b.x1,
                Math.min(c.y, d.y), Math.abs(b.x1 - b.x2), Math.abs(d.y - c.y)), d = !1) : d = !0;
            a.beginPath()
        };
        E.prototype.renderStripLinesOfThicknessType = function (a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                for (b = 0; b < this._stripLineLabels.length; b++) if (h = this.stripLines[b],
                    ...
                    2 ? (a.y << 0) + 0.5 : a.y << 0, this.ctx.beginPath(), this.ctx.moveTo(a.x << 0, r), this.ctx.lineTo(a.x + this.tickLength << 0, r), this.ctx.stroke(), 0 === this.labelAngle ? a.x = a.x + this.tickLength + 5 : (a.y = 0 > this.labelAngle ? a.y : a.y - (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle), a.x = 0 < this.labelAngle ? a.x + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : a.x + this.tickLength + 5)); else c.textBlock.angle = -90, "bottom" === this._position ? (c.textBlock.maxWidth =
                        ...
                        this._position && (c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth ? this.options.stripLines[b].labelMaxWidth : this.chart.plotArea.width - 3, c.textBlock.angle = 0, c.textBlock.measureText(), a.y - +c.textBlock.height > this.chart.plotArea.y1 ? s(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 - 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : s(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height /
                            2 - c.textBlock.fontSize / 2 + 3, a.x = "near" === c.stripLine.labelAlign ? this.chart.plotArea.x2 - c.textBlock.width - 3 : "center" === c.stripLine.labelAlign ? (this.chart.plotArea.x2 + this.chart.plotArea.x1) / 2 - c.textBlock.width / 2 : this.chart.plotArea.x1 + 3);
                    c.textBlock.x = a.x;
                    c.textBlock.y = a.y;
                    l.push(c)
                }
                if (!k) {
                    ...
                    this.ctx.clip();
                    for (b = 0; b < m.length; b++) h = m[b], h.showOnTop ?
        ...
        E.prototype.renderAxisLine = function () {
            var a = this.chart.ctx, d = t ? this.chart._preRenderCtx : a,
                c = Math.ceil(this.tickThickness / (this.reversed ? -2 :
                    2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f;
            d.save();
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    ...
                    var k = 1 === this.lineThickness % 2 ? (this.lineCoordinates.y1 << 0) + 0.5 : this.lineCoordinates.y1 <<
                        0;
                    d.beginPath();
                ...
                d.beginPath();
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel +
                    c; else for (m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) d.moveTo(k, e), d.lineTo(k, this.scaleBreaks._appliedBreaks[m].startPixel + b), e = this.scaleBreaks._appliedBreaks[m].endPixel + c;
        ...
        E.prototype.convertPixelToValue = function (a) {
            ...
            if (this.logarithmic) {
                ...
                if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (c = 0; c < e.length; c++) {
                    if (!(e[c].endValue < this.conversionParameters.minimum)) if (d) if (e[c].startValue < this.conversionParameters.minimum) {
                        if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue /
                            e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) {
                        ...
                        b /= e[c].size;
                        d = !1
                    } else break; else if (b > e[c].startValue / e[c - 1].endValue) {
                    ...
                    if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) > e[c].startValue) {
                        a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size));
                        break
                    } else a *= e[c].startValue / this.conversionParameters.minimum * Math.pow(e[c].size, Math.log(e[c].startValue / this.conversionParameters.minimum) / Math.log(e[c].endValue /
                        e[c].startValue)) * b, b *= Math.pow(e[c].size, Math.log(this.conversionParameters.minimum / e[c].startValue) / Math.log(e[c].endValue / e[c].startValue));
                    d = !1
                ...
                if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (c = 0; c < e.length; c++) {
                    ...
                    this.conversionParameters.minimum)) if (d) if (e[c].endValue > this.conversionParameters.minimum) if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size > e[c].startValue) {
                    a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size;
                    break
                } else a += e[c].startValue - this.conversionParameters.minimum + e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue), b += e[c].size * (this.conversionParameters.minimum - e[c].startValue) / (e[c].endValue - e[c].startValue),
                    d = !1; else if (b < e[c].endValue - this.conversionParameters.minimum) {
                    b -= e[c].endValue - this.conversionParameters.minimum;
                    if (b > -1 * e[c].size) {
                        a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) + b;
                        break
        ...
        E.prototype.convertValueToPixel = function (a) {
            ...
            return this.logarithmic ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * Math.log(a / this.conversionParameters.minimum) / this.conversionParameters.lnLogarithmBase + 0.5 << 0 : "axisX" === this.type ? this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * (a - this.conversionParameters.minimum) +
        ...
        E.prototype.getApparentDifference = function (a, d, c, b) {
            ...
            if (this.logarithmic) {
                c = s(c) ? d / a : c;
                for (var f = 0; f < e.length && !(d < e[f].startValue); f++) a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? c = c / e[f].endValue * e[f].startValue * e[f].size : a >= e[f].startValue && d >= e[f].endValue ? c = c / e[f].endValue * a * Math.pow(e[f].size, Math.log(e[f].endValue /
            ...
            d >= e[f].endValue ? c = c - e[f].endValue + a + e[f].size * (e[f].endValue - a) / (e[f].endValue - e[f].startValue) : a <= e[f].startValue && d < e[f].endValue ? c = c - d + e[f].startValue + e[f].size * (d - e[f].startValue) / (e[f].endValue - e[f].startValue) : !b && (a > e[f].startValue && d < e[f].endValue) && (c = a + e[f].size * (d - a) / (e[f].endValue - e[f].startValue)));
            return c
        };
        ...
        E.prototype.calculateValueToPixelConversionParameters = function (a) {
            ...
            var d = {pixelPerUnit: null, minimum: null, reference: null}, c = this.lineCoordinates.width,
                b = this.lineCoordinates.height, c = "bottom" === this._position || "top" === this._position ? c : b,
            ...
            if (this.logarithmic) for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b /
                ...
                this.viewportMaximum < a[e].endValue && (b = b - this.viewportMaximum + a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)));
            d.minimum = this.viewportMinimum;
            d.maximum = this.viewportMaximum;
            d.range = b;
            if ("bottom" === this._position || "top" === this._position) this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase),
                d.pixelPerUnit = (this.reversed ? -1 : 1) * c * d.lnLogarithmBase / Math.log(Math.abs(b))) : d.pixelPerUnit = (this.reversed ? -1 : 1) * c / Math.abs(b), d.reference = this.reversed ? this.lineCoordinates.x2 : this.lineCoordinates.x1;
        ...
        E.prototype.calculateAxisParameters = function () {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
                ...
                var a = "axisX" === this.type ? "xySwapped" === this.chart.plotInfo.axisPlacement ? 62 : 70 : "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 : 40,
                    b = 4;
                "axisX" === this.type &&
                (b = 600 > this.maxWidth ? 8 : 6);
                var a = Math.max(b, Math.floor(this.maxWidth / a)), e, f, k, b = 0;
                ...
                if (s(this.options.viewportMinimum) && !s(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum = this.sessionVariables.newViewportMinimum; else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum =
                    this.minimum;
                ...
                if (this.scaleBreaks) for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++) if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue ||
                ...
                if ("axisX" === this.type) {
                    ...
                    Infinity !== this.dataInfo.minDiff ? k = this.dataInfo.minDiff : 1 < f - e ? k = 0.5 * Math.abs(f - e) : (k = 1, c &&
                    (d = !0))
                ...
                b = this.getApparentDifference(isNaN(this.viewportMinimum) ||
                null === this.viewportMinimum ? e : this.viewportMinimum, isNaN(this.viewportMaximum) || null === this.viewportMaximum ? f : this.viewportMaximum, null, !0);
                if ("axisX" === this.type && c) {
                    ...
                    a ? (this.interval = 3, this.intervalType = "week") : b / (1 * R.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * R.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : b / (3 * R.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * R.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * R.yearDuration) <= a ? 1 : b / (2 * R.yearDuration) <= a ? 2 : b / (4 * R.yearDuration) <= a ? 4 : Math.floor(E.getNiceNumber(b / (a - 1), !0) / R.yearDuration), this.intervalType = "year"));
                    if (null ===
                        this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = e - k / 2;
                    ...
                    if (null === this.viewportMinimum ||
                        isNaN(this.viewportMinimum)) this.viewportMinimum = "axisX" === this.type ? e - k / 2 : Math.floor(e / this.interval) * this.interval;
                ...
                this.maximum ? this.maximum : this.dataInfo.max, isFinite(e) || isFinite(f) ? 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += b, e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += b), 0 !== e && (e -= b)) : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ?
                    0 : Infinity), k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < e && (e = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > f && (f = 0)), Math.abs(this.getApparentDifference(e, f, null, !0)), "axisX" === this.type && c) {
                    this.valueType = "dateTime";
                    if (null === this.minimum || isNaN(this.minimum)) this.minimum = e - k / 2;
                    if (null === this.maximum || isNaN(this.maximum)) this.maximum = f + k / 2
                } else this.intervalType = this.valueType =
                    ...
                    -Infinity : this.sessionVariables.viewportMaximum)), 0 === this.maximum && 0 === this.minimum && (0 === this.options.minimum ? this.maximum += 10 : 0 === this.options.maximum && (this.minimum -= 10));
                ...
                this.intervalStartPosition = "axisX" === this.type && c ?
                    this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval) : Math.floor((this.viewportMinimum + 0.2 * this.interval) / this.interval) * this.interval;
        ...
        E.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            if (this.scaleBreaks) for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++) if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >=
                ...
                this.viewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue)) {
            ...
            this.options && 0 < this.options.interval ? this.interval =
                this.options.interval : (this.interval = E.getNiceExponent(Math.log(k) / d / (a - 1), !0), c = E.getNiceNumber(m / (a - 1), !0));
            ...
            if (null === this.minimum || null === this.maximum) "axisX" === this.type ?
        ...
        E.getNiceExponent = function (a, d) {
            ...
            b ? 5 : 10 : Math.max(Math.floor(b), 1);
        ...
        E.prototype.getLabelStartPoint = function () {
            ...
            if ("millisecond" !== this.intervalType) if ("second" ===
                this.intervalType) 0 < a.getMilliseconds() && (a.setSeconds(a.getSeconds() + 1), a.setMilliseconds(0)); else if ("minute" === this.intervalType) {
        ...
        U.prototype.render = function (a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                this.ctx.setLineDash(N(this.lineDashType, q));
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === q % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, m = this.chart.plotArea.y2 + q / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
                    x1: b - q / 2,
                    y1: e,
                    x2: k + q / 2,
                    y2: m
                }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position &&
                0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, m), this.ctx.lineTo(k, m), this.ctx.lineTo(k, e); else if ("wavy" === this.type) {
                    l = b;
                    h = e;
                    f = 0.5;
                    r = (m - h) / a / 3;
                    ...
                    if ("zigzag" === this.type) {
                        ...
                        l = b + a;
                        r = (m - h) / a / 2;
                        for (p = 0; p < r; p++) this.ctx.lineTo(l,
                            h), l += 2 * f * a, h += 2 * a, f *= -1;
                        this.ctx.lineTo(l, h);
                        l += k - b;
                    ...
                    f *= -1;
                    this.ctx.lineTo(l, h);
                    for (p = 0; p < r; p++) this.ctx.bezierCurveTo(l - a, h + f * a, l - 2 * a,
        ...
        M.prototype.render = function () {
            ...
            var a = this.parent.getPixelCoordinatesOnAxis(this.value),
                d = Math.abs("pixel" === this._thicknessType ? this.thickness :
        ...
        aa.prototype.showAt = function (a) {
            ...
            d.axisX[b] && (d.axisX[b]._crosshairValue = a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum ? a : null); else {
            ...
            } else if ("bottom" === this.parent._position) for (b = 0; b < d.axisX.length; b++) this.parent === d.axisX[b] && (d.axisX[b]._crosshairValue = a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum ? a : null); else if ("top" ===
        ...
        aa.prototype.render = function (a, d, c) {
            ...
            var h = null === this.opacity ? 1 : this.opacity,
                ...
                p = this.chart.overlaidCanvasCtx, g = p.globalAlpha;
            p.globalAlpha = h;
            p.beginPath();
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var v = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) t = this.parent.dataSeries[0].axisX.convertPixelToValue({y: d}); else if ("left" === this.parent._position || "right" === this.parent._position) t =
                    ...
                    w = 0;
                    if ("rangeBar" === r[0].dataSeries.type || "error" === r[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(r[w].dataPoint.y[0])),
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            m = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(z) <<
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y));
                            D = z = u = 0;
                            for (t = w; 0 <= t; t--) z += r[t].dataPoint.y, D = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() :
                                r[t].dataPoint.x, D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(a - this.parent.convertValueToPixel(D)), u < v && (v = u, b = t);
                        ...
                        D = !1;
                        if (this.parent.labels) for (r =
                                                         Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += r) if (this.parent.labels[t]) D = !0; else {
                            D = !1;
                            break
                        }
                        if (D) {
                            if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({y: d}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                    ...
                    if (D) {
                        if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({x: a}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                    ...
                    0 < this.parent.dataSeries.length && (t = this.parent.dataSeries[0].axisX.convertPixelToValue({x: a}));
                    for (w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && r.push(v));
                    if (0 === r.length) return;
                    r.sort(function (a, b) {
                        return a.distance - b.distance
                    ...
                    w = 0;
                    if ("rangeColumn" === r[0].dataSeries.type || "rangeArea" === r[0].dataSeries.type || "error" === r[0].dataSeries.type || "rangeSplineArea" === r[0].dataSeries.type ||
                        ...
                        r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t); else u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
                    x = r[w];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type ||
                        ...
                        l = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 : this.parent.convertValueToPixel(z) <<
                            0;
                        h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y));
                        z = u = 0;
                        for (t = w; 0 <= t; t--) z += r[t].dataPoint.y, D = r[t].dataPoint.x.getTime ?
                            r[t].dataPoint.x.getTime() : r[t].dataPoint.x, D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(d - this.parent.convertValueToPixel(D)), u < v && (v = u, b = t);
                    ...
                    this.parent.dataSeries[w].type ? (l = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        ...
                        this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (l = 1 === p.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: x.dataPoint.y
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - h.fontSize / 2 + h.measureText().height > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2), b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.viewportMaximum) && (0 < q && (p.moveTo(b,
                    f), p.lineTo(e, k), p.stroke(), this._hidden = !1), p.restore(), !s(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
                if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "right" === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.measureText().width), k >= this.parent.convertValueToPixel(this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.viewportMinimum) &&
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = m = 1 === p.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = {
                    ...
                    x2: e + q / 2,
                    y2: k
                }; else if ("left" === this.parent._position || "right" === this.parent._position) f = k = l = 1 === p.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
                    this.bounds = {x1: b, y1: f - q / 2, x2: e, y2: k + q / 2};
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                    ...
                    }) : s(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                    ...
                    D = !1;
                    r = "";
                    if (this.parent.labels) for (r = Math.ceil(this.parent.interval),
                                                     t = 0; t < this.parent.viewportMaximum; t += r) if (this.parent.labels[t]) D = !0; else {
                        D = !1;
                        break
                    }
                    if (D) {
                    ...
                    crosshair: this.options,
                    value: c ? c : this.parent.convertPixelToValue(d)
                }) : s(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label, h.y = d + h.fontSize / 2 - h.measureText().height / 2 + 2, h.y - h.fontSize / 2 < this.chart.bounds.y1 ? h.y = this.chart.bounds.y1 + h.fontSize / 2 + 2 : h.y + h.measureText().height - h.fontSize / 2 > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 -
            ...
            if ("bottom" === this.parent._position ||
                "top" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(m);
        ...
        X.prototype._updateToolTip = function (a, d, c) {
            ...
            if (!this.chart.disableToolTip) {
                ...
                var b = null, e = null, f = [], k = 0;
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        var m = [];
                        if (this.chart.axisX) for (var l = 0; l < this.chart.axisX.length; l++) {
                            for (var k =
                                this.chart.axisX[l].convertPixelToValue({y: d}), h = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++) (h = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[l].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                            h = null
                        }
                        if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) {
                            k = this.chart.axisX2[l].convertPixelToValue({y: d});
                            h = null;
                            for (b = 0; b < this.chart.axisX2[l].dataSeries.length; b++) (h = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index &&
                            (h.dataSeries = this.chart.axisX2[l].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                            h = null
                        }
                    } else {
                        m = [];
                        if (this.chart.axisX) for (l = 0; l < this.chart.axisX.length; l++) for (k = this.chart.axisX[l].convertPixelToValue({x: a}), h = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++) (h = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[l].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                        if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) for (k = this.chart.axisX2[l].convertPixelToValue({x: a}),
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex =
                        h.dataSeries.index; else if (t) if (h = Za(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) {
                ...
                if (0 < f.length) {
                    ...
                    if (this.enabled) {
                        var r = "", r = this.getToolTipInnerHTML({entries: f});
                        if (null !== r) {
                    ...
                    r = {chart: this.chart, toolTip: this.options, content: r, entries: d};
                    this._entries = f;
        ...
        X.prototype.getToolTipInnerHTML = function (a) {
            a = a.entries;
            for (var d = null, c = null, b = null, e = 0, f = "", k = !0, l = 0; l < a.length; l++) if (a[l].dataSeries.toolTipContent ||
                a[l].dataPoint.toolTipContent) {
                k = !1;
                break
            }
        ...
        ca.prototype.reset = function () {
            ...
            this.previousDataPointEventObject = null;
            this.eventObjects = [];
            t && (this.ghostCtx.clearRect(0, 0, this.chart.width,
        ...
        var L = {
            yScaleAnimation: function (a, d) {
                ...
                if (0 !== a) {
                    ...
                    c.save();
                    0 < a && c.drawImage(b, 0, 0, b.width * a, b.height, 0, 0, b.width * a / ha, b.height /
                        ha);
                    c.restore()
                }
